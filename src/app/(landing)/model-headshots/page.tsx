...
// UI components for the model headshots landing page.
...
import ModelBenefitsSection from "@/components/landing-page/model-headshots/model-benefits-section";
import { FAQSection } from "@/components/landing-page/faq-section";

// Static data and utility functions for the page content.
import { modelHeadshotsReviews } from "@/data/reviews";
import { modelPricing } from "@/data/one-time-pricing-details";
import { getLogosBySlug } from "@/data/trusted-logos";

const { logos } = getLogosBySlug("model");

const keypoints = ["100% money-back", "Fully private & secure"];

// Custom steps data for Model headshots - Updated content
const modelFaqCategories = [
  {
    category: "What Are AI Model Headshots?",
    questions: [
      {
        question: "What is a model headshot?",
        answer:
          "A model headshot is a professional shoulders-up photo used for agency submissions, casting calls, portfolios, and other modeling industry materials.",
      },
      {
        question: "Why do model headshots matter?",
        answer:
          "They shape first impressions, build trust, and help you get noticed by agencies, brands, and casting directors.",
      },
      {
        question: "What is an AI model headshot?",
        answer:
          "It's a professional model headshot created from your casual selfies using Headshot.AI.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Aspiring models, signed models, commercial models, fashion models, fitness models, and freelance talent.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Yes. You can select one or more backgrounds: studio, dark studio, outdoor.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question: "What packages does Headshot.AI offer for models?",
        answer:
  ...
  },
  {
    ...
    questions: [
      {
        question: "Where can I use my model headshots?",
        answer:
          "Agency submissions, casting profiles, Model Mayhem, social media, comp cards, portfolios, brand pitches, and press kits.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, as long as the image accurately represents you. Agencies and brands want to see the real you — our AI headshots deliver that.",
      },
    ],
  },
  {
...
const modelSteps: StepData[] = [
  {
    number: 1,
    title: "Choose Your Background",
    description:
      "Select one or more backgrounds: studio, dark studio, outdoor.",
    images: [
      "/assets/landing-page/model/how-it-works/step-1/background/1.studio.webp",
      "/assets/landing-page/model/how-it-works/step-1/background/2.dark-studio.webp",
      "/assets/landing-page/model/how-it-works/step-1/background/3.outdoor.webp",
    ],
    labels: ["Studio", "Dark Studio", "Outdoor"],
  },
  {
    number: 2,
    ...
    images: [
      "/assets/landing-page/model/how-it-works/step-2/1.webp",
      "/assets/landing-page/model/how-it-works/step-2/2.webp",
      "/assets/landing-page/model/how-it-works/step-2/3.webp",
    ],
  },
  {
    number: 3,
    ...
    description:
      "In under 15 minutes, our AI turns your selfies into studio-quality model headshots with professional attire and the backgrounds you've chosen.",
    images: ["/assets/landing-page/model/how-it-works/step-3/1.webp"],
  },
  {
    number: 4,
    title: "Download Your Headshots",
    description:
      "Review your gallery of 150 model headshots and download your favorites for instant use.",
    images: [
      "/assets/landing-page/model/how-it-works/step-4/1.webp",
      "/assets/landing-page/model/how-it-works/step-4/2.webp",
      "/assets/landing-page/model/how-it-works/step-4/3.webp",
      "/assets/landing-page/model/how-it-works/step-4/4.webp",
      "/assets/landing-page/model/how-it-works/step-4/5.webp",
      "/assets/landing-page/model/how-it-works/step-4/6.webp",
    ],
  },
];
...
export const metadata = createPageMetadata({
  title: "#1 AI Model Headshot Generator | 15 Minutes",
  description:
    "Turn your selfies into studio quality model headshots. Perfect for comp cards, portfolios and casting calls. Rated 4.9/5 by thousands. Get yours now.",
  canonicalPath: "/model-headshots",
});
...
export default function ModelHeadshotsPage() {
  return (
    <main className="flex flex-col space-y-24 sm:space-y-32 ">
      <HeroSection
        badgeText="#1 AI MODEL HEADSHOT GENERATOR"
        title="Get Professional Model Headshots in 15 Minutes"
        highlight="15 Minutes"
        description="Turn your casual selfies into studio-quality model headshots that look exactly like you. Over 90% less than studio prices."
        ctaText="Get My Headshots Now"
        logos={logos}
        keypoints={keypoints}
        category="model"
        trustedByText="Over 219,100 AI headshots generated for 2,500+ models"
        trustedByTexthighlight={["219,100", "2,500+"]}
        usedByText="Used by models across the industry"
        showRating={true}
      />
      <HowItWorksSection
        mainTitle="Casual Selfies to Studio-Quality Model Headshots"
        highlight="Selfies to Studio-Quality"
        subtitle="No photoshoot. No dressing up. Just four simple steps."
        steps={modelSteps}
      />
      <ReviewsSection
        reviews={modelHeadshotsReviews}
        title="Trusted by 2,500+ Models"
        highlight="2,500+"
        subtitle="Read reviews from models using our headshots for comp cards, agency submissions, and casting calls."
      />
      <ModelBenefitsSection
        title="Boost up to 4× More Callbacks and Booking Requests"
        highlight="4× More"
        description="Command attention across comp cards, agency portfolios, and casting submissions."
      />
      <GalleryReviewsSection
        category="model"
        title="Model Headshots"
        highlight="Model"
        subtitle="See how our AI turns your selfies into studio-quality model headshots — in minutes."
        description="They look like a high-end studio shoot-but they're 100% AI-generated from your selfies."
      />
      <PricingSection
        pricingDetails={modelPricing}
        title="Model Headshots — Over 90% Less Than Studio Prices"
        description="Get studio-quality model headshots — without the $500+ cost."
        highlight="90% Less"
      />
      ...
      <CTASection
        category="model"
        title="Your Studio-Quality Model Headshots Are Minutes Away"
        highlight="Model Headshots"
        ctaText="Get My Headshots Now"
      />
