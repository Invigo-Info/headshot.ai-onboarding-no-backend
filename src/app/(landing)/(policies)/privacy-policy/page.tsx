...
export const metadata = createPageMetadata({
  title: 'Privacy Policy | Headshot.AI',
  description: 'Learn how Headshot.AI protects your data. Your selfies and headshots are never sold or shared. GDPR & CCPA compliant. Read our privacy policy.',
