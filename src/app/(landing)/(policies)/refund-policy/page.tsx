...
export const metadata = createPageMetadata({
  title: 'Refund Policy | Headshot.AI',
  description: 'Not satisfied? We\'ll rerun your headshots or refund you. 100% money-back guarantee within 7 days. Read our full refund policy.',
  ...
  return (
    <main className="container mx-auto px-4">
      <div className="max-w-5xl mx-auto py-16">
        <h1 className="text-3xl sm:text-4xl font-bold text-center">Refund Policy</h1>
