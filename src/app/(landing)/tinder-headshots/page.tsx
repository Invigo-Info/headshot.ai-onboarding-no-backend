...
// UI components for the tinder headshots landing page.
...
import TinderBenefitsSection from "@/components/landing-page/tinder-headshots/tinder-benefits-section";
...
import { tinderHeadshotsReviews } from "@/data/reviews";
import { tinderPricing } from "@/data/one-time-pricing-details";
import { getLogosBySlug } from "@/data/trusted-logos";

const { logos } = getLogosBySlug("tinder");

const keypoints = ["100% money-back", "Fully private & secure"];

// Custom steps data for Tinder headshots - Updated content
const tinderFaqCategories = [
  {
    category: "What Are AI Tinder Headshots?",
    questions: [
      {
        question: "What is a Tinder headshot?",
        answer:
          "A Tinder headshot is a profile picture designed to help you stand out on Tinder, attract quality matches, and start real conversations.",
      },
      {
        question: "Why do Tinder headshots matter?",
        answer:
          "They're your first impression. Great photos get more right swipes, more matches, and more messages.",
      },
      {
        question: "What is an AI Tinder headshot?",
        answer:
          "It's a natural, high-quality Tinder photo created from your casual selfies using Headshot.AI.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Anyone looking for love online — whether you're new to Tinder or just need better photos.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question: "What packages does Headshot.AI offer for Tinder users?",
        answer:
    ...
    questions: [
      {
        ...
        answer:
          "All of them! Tinder, Bumble, Hinge, Coffee Meets Bagel, Happn, OkCupid, Match, or any other dating app. Plus social media and anywhere else you want great photos.",
      },
      {
      ...
      {
        question: "Is using AI headshots on Tinder acceptable?",
        answer:
...
const tinderSteps: StepData[] = [
  {
    ...
    images: [
      "/assets/landing-page/tinder/how-it-works/step-1/1.webp",
      "/assets/landing-page/tinder/how-it-works/step-1/2.webp",
      "/assets/landing-page/tinder/how-it-works/step-1/3.webp",
    ],
  },
  {
    number: 3,
    ...
    description:
      "In under 15 minutes, our AI transforms your selfies into stunning Tinder headshots with different outfits, settings, and vibes — all designed to help you stand out and spark real connections.",
    images: ["/assets/landing-page/tinder/how-it-works/step-2/1.webp"],
  },
  {
    number: 4,
    title: "Download Your Favorites",
    description:
      "Pick your best photos and download them for instant use on Tinder — or any other dating app.",
    images: [
      "/assets/landing-page/tinder/how-it-works/step-4/1.webp",
      "/assets/landing-page/tinder/how-it-works/step-4/2.webp",
      "/assets/landing-page/tinder/how-it-works/step-4/3.webp",
    ],
  },
];
...
export const metadata = createPageMetadata({
  title: "#1 AI Tinder Headshot Generator | 15 Minutes",
  description:
    "Turn your selfies into studio quality Tinder headshots. Perfect for profiles that look natural and stand out. Rated 4.9/5 by thousands. Get yours now.",
  canonicalPath: "/tinder-headshots",
});

export default function TinderHeadshotsPage() {
  return (
    <main className="flex flex-col space-y-24 sm:space-y-32 ">
      <HeroSection
        badgeText="#1 AI TINDER HEADSHOT GENERATOR"
        title="Get Tinder Headshots in 15 Minutes"
        highlight="15 Minutes"
        description="Turn your casual selfies into studio-quality Tinder headshots that look exactly like you. Over 90% less than studio prices."
        ctaText="Get My Headshots Now"
        logos={logos}
        keypoints={keypoints}
        category="tinder"
        trustedByText="Over 236,500 AI headshots generated for 2,700+ singles"
        trustedByTexthighlight={["236,500", "2,700+"]}
        usedByText="As seen in"
        showRating={true}
      />
      <HowItWorksSection
        mainTitle="Casual Selfies to Studio-Quality Tinder Headshots"
        highlight="Selfies to Studio-Quality"
        subtitle="No photoshoot. No dressing up. Just four simple steps."
        steps={tinderSteps}
      />
      <ReviewsSection
        reviews={tinderHeadshotsReviews}
        title="Trusted by 2,700+ Tinder Users"
        highlight="2,700+"
        subtitle="Read reviews from singles using our headshots to get more right swipes, better matches, and more conversations."
      />
      <TinderBenefitsSection
        title="Win up to 5× More Right Swipes and Better Matches"
        highlight="5× More"
        description="Look attractive, confident, and swipe-worthy on your Tinder profile."
      />
      <GalleryReviewsSection
        category="tinder"
        title="Tinder Headshots"
        highlight="Tinder"
        subtitle="See how our AI turns your selfies into studio-quality Tinder headshots — in minutes."
        description="They look like a professional photographer took them-but they're 100% AI-generated from your selfies."
      />
      <PricingSection
        pricingDetails={tinderPricing}
        title="Tinder Headshots — Over 90% Less Than Studio Prices"
        description="Get studio-quality Tinder headshots — without the $500+ cost."
        highlight="90% Less"
      />
      ...
      />
      <FAQSection
        categories={tinderFaqCategories}
      ...
      <CTASection
        category="tinder"
        title="Your Studio-Quality Tinder Headshots Are Minutes Away"
        highlight="Tinder Headshots"
        ctaText="Get My Headshots Now"
      />
