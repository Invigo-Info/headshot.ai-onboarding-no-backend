...
// UI components for the massage therapist headshots landing page.
...
import MassageTherapistBenefitsSection from "@/components/landing-page/massage-therapist-headshots/massage-therapist-benefits-section";
import { FAQSection } from "@/components/landing-page/faq-section";

// Static data and utility functions for the page content.
import { massageTherapistHeadshotsReviews } from "@/data/reviews";
import { massageTherapistPricing } from "@/data/one-time-pricing-details";
import { getLogosBySlug } from "@/data/trusted-logos";

const { logos } = getLogosBySlug("massage-therapist");

const keypoints = ["100% money-back", "Fully private & secure"];

// Custom steps data for Massage Therapist headshots - Updated content
const massagetherapistFaqCategories = [
  {
    category: "What Are AI Massage Therapist Headshots?",
    questions: [
      {
        question: "What is a massage therapist headshot?",
        answer:
          "A massage therapist headshot is a professional shoulders-up photo used on spa websites, booking platforms, social media, and wellness directories.",
      },
      {
        question: "Why do massage therapist headshots matter?",
        answer:
          "They shape first impressions, build trust, and help increase bookings, referrals, and client inquiries.",
      },
      {
        question: "What is an AI massage therapist headshot?",
        answer:
          "It's a professional massage therapist headshot created from your casual selfies using Headshot.AI.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Licensed massage therapists, spa therapists, sports massage specialists, wellness practitioners, and bodywork professionals.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Yes. You can select one or more backgrounds: studio, spa and wellness, outdoor.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question:
          "What packages does Headshot.AI offer for massage therapists?",
        answer:
  ...
  },
  {
    ...
    questions: [
      {
        question: "Where can I use my massage therapist headshots?",
        answer:
          "Spa websites, wellness directories, booking apps, Google Business profiles, social media, business cards, brochures, email signatures, and client intake forms.",
      },
      {
...
const massagetherapistSteps: StepData[] = [
  {
    number: 1,
    title: "Choose Your Background",
    description:
      "Select one or more backgrounds: studio, spa and wellness, outdoor.",
    images: [
      "/assets/landing-page/massage-therapist/how-it-works/step-1/background/1.studio.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-1/background/2.spa-and-wellness.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-1/background/3.outdoor.webp",
    ],
    labels: ["Studio", "Spa and Wellness", "Outdoor"],
  },
  {
    number: 2,
    ...
    images: [
      "/assets/landing-page/massage-therapist/how-it-works/step-2/1.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-2/2.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-2/3.webp",
    ],
  },
  {
    number: 3,
    ...
    description:
      "In under 15 minutes, our AI turns your selfies into studio-quality massage therapist headshots with professional attire and the backgrounds you've chosen.",
    images: [
      "/assets/landing-page/massage-therapist/how-it-works/step-3/1.webp",
    ],
  },
  {
    number: 4,
    ...
    description:
      "Review your gallery of 150 massage therapist headshots and download your favorites for instant use.",
    images: [
      "/assets/landing-page/massage-therapist/how-it-works/step-4/1.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-4/2.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-4/3.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-4/4.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-4/5.webp",
      "/assets/landing-page/massage-therapist/how-it-works/step-4/6.webp",
    ],
  },
];
...
export const metadata = createPageMetadata({
  title: "#1 AI Massage Therapist Headshot Generator | 15 Minutes",
  description:
    "Turn your selfies into studio quality massage therapist headshots. Perfect for booking platforms and LinkedIn. Rated 4.9/5 by thousands. Get yours now.",
  canonicalPath: "/massage-therapist-headshots",
});

export default function MassageTherapistHeadshotsPage() {
  return (
    <main className="flex flex-col space-y-24 sm:space-y-32 ">
      <HeroSection
        badgeText="#1 AI MASSAGE THERAPIST HEADSHOT GENERATOR"
        title="Get Professional Massage Therapist Headshots in 15 Minutes"
        highlight="15 Minutes"
        description="Turn your casual selfies into studio-quality massage therapist headshots that look exactly like you. Over 90% less than studio prices."
        ctaText="Get My Headshots Now"
        logos={logos}
        keypoints={keypoints}
        category="massage-therapist"
        trustedByText="Over 87,600 AI headshots generated for 1,000+ massage therapists"
        trustedByTexthighlight={["87,600", "1,000+"]}
        usedByText="Used by massage therapists across the wellness industry"
        showRating={true}
      />
      <HowItWorksSection
        mainTitle="Casual Selfies to Studio-Quality Massage Therapist Headshots"
        highlight="Selfies to Studio-Quality"
        subtitle="No photoshoot. No dressing up. Just four simple steps."
        steps={massagetherapistSteps}
      />
      <ReviewsSection
        reviews={massageTherapistHeadshotsReviews}
        title="Trusted by 1,000+ Massage Therapists"
        highlight="1,000+"
        subtitle="Read reviews from massage therapists using our headshots for spa websites, wellness directories, and booking apps."
      />
      <MassageTherapistBenefitsSection
        title="Increase up to 2× More Client Bookings and Repeat Visits"
        highlight="2× More"
        description="Help clients feel at ease before they arrive — across booking sites and wellness directories."
      />
      <GalleryReviewsSection
        category="massage-therapist"
        title="Massage Therapist Headshots"
        highlight="Massage Therapist"
        subtitle="See how our AI turns your selfies into studio-quality massage therapist headshots — in minutes."
        description="They look like a high-end studio shoot-but they're 100% AI-generated from your selfies."
      />
      <PricingSection
        pricingDetails={massageTherapistPricing}
        title="Massage Therapist Headshots — Over 90% Less Than Studio Prices"
        description="Get studio-quality massage therapist headshots — without the $500+ cost."
        highlight="90% Less"
      />
      ...
      />
      <FAQSection
        categories={massagetherapistFaqCategories}
      ...
      <CTASection
        category="massage-therapist"
        title="Your Studio-Quality Massage Therapist Headshots Are Minutes Away"
        highlight="Massage Therapist Headshots"
        ctaText="Get My Headshots Now"
      />
