...
// UI components for the makeup artist headshots landing page.
...
import MakeupArtistBenefitsSection from "@/components/landing-page/makeup-artist-headshots/makeup-artist-benefits-section";
import { FAQSection } from "@/components/landing-page/faq-section";

// Static data and utility functions for the page content.
import { makeupArtistHeadshotsReviews } from "@/data/reviews";
import { makeupArtistPricing } from "@/data/one-time-pricing-details";
import { getLogosBySlug } from "@/data/trusted-logos";

const { logos } = getLogosBySlug("makeup-artist");

const keypoints = ["100% money-back", "Fully private & secure"];

// Custom steps data for Makeup Artist headshots - Updated content
const makeupartistFaqCategories = [
  {
    category: "What Are AI Makeup Artist Headshots?",
    questions: [
      {
        question: "What is a makeup artist headshot?",
        answer:
          "A makeup artist headshot is a professional shoulders-up photo used on portfolio websites, booking platforms, social media, and other beauty industry materials.",
      },
      {
        question: "Why do makeup artist headshots matter?",
        answer:
          "They shape first impressions, build trust, and help you attract clients, bookings, and collaboration opportunities.",
      },
      {
        question: "What is an AI makeup artist headshot?",
        answer:
          "It's a professional makeup artist headshot created from your casual selfies using Headshot.AI.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Cosmetology students, freelance makeup artists, bridal makeup artists, editorial makeup artists, special effects artists, and beauty entrepreneurs.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Yes. You can select one or more backgrounds: studio, makeup studio, outdoor.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question: "What packages does Headshot.AI offer for makeup artists?",
        answer:
  ...
  },
  {
    ...
    questions: [
      {
        question: "Where can I use my makeup artist headshots?",
        answer:
          "Portfolio websites, booking platforms, LinkedIn, social media, business cards, comp cards, bridal directories, agency profiles, and press features.",
      },
      {
...
const makeupartistSteps: StepData[] = [
  {
    number: 1,
    title: "Choose Your Background",
    description:
      "Select one or more backgrounds: studio, makeup studio, outdoor.",
    images: [
      "/assets/landing-page/makeup-artist/how-it-works/step-1/background/1.studio.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-1/background/2.makeup-studio.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-1/background/3.outdoor.webp",
    ],
    labels: ["Studio", "Makeup Studio", "Outdoor"],
  },
  {
    number: 2,
    ...
    images: [
      "/assets/landing-page/makeup-artist/how-it-works/step-2/1.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-2/2.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-2/3.webp",
    ],
  },
  {
    number: 3,
    ...
    description:
      "In under 15 minutes, our AI turns your selfies into studio-quality makeup artist headshots with professional attire and the backgrounds you've chosen.",
    images: ["/assets/landing-page/makeup-artist/how-it-works/step-3/1.webp"],
  },
  {
    number: 4,
    title: "Download Your Headshots",
    description:
      "Review your gallery of 150 makeup artist headshots and download your favorites for instant use.",
    images: [
      "/assets/landing-page/makeup-artist/how-it-works/step-4/1.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-4/2.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-4/3.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-4/4.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-4/5.webp",
      "/assets/landing-page/makeup-artist/how-it-works/step-4/6.webp",
    ],
  },
];
...
export const metadata = createPageMetadata({
  title: "#1 AI Makeup Artist Headshot Generator | 15 Minutes",
  description:
    "Turn your selfies into studio quality makeup artist headshots. Perfect for portfolios, beauty sites and LinkedIn. Rated 4.9/5 by thousands. Get yours now.",
  canonicalPath: "/makeup-artist-headshots",
});

export default function MakeupArtistHeadshotsPage() {
  return (
    <main className="flex flex-col space-y-24 sm:space-y-32 ">
      <HeroSection
        badgeText="#1 AI MAKEUP ARTIST HEADSHOT GENERATOR"
        title="Get Professional Makeup Artist Headshots in 15 Minutes"
        highlight="15 Minutes"
        description="Turn your casual selfies into studio-quality makeup artist headshots that look exactly like you. Over 90% less than studio prices."
        ctaText="Get My Headshots Now"
        logos={logos}
        keypoints={keypoints}
        category="makeup-artist"
        trustedByText="Over 140,200 AI headshots generated for 1,600+ makeup artists"
        trustedByTexthighlight={["140,200", "1,600+"]}
        usedByText="Used by makeup artists across the beauty industry"
        showRating={true}
      />
      <HowItWorksSection
        mainTitle="Casual Selfies to Studio-Quality Makeup Artist Headshots"
        highlight="Selfies to Studio-Quality"
        subtitle="No photoshoot. No dressing up. Just four simple steps."
        steps={makeupartistSteps}
      />
      <ReviewsSection
        reviews={makeupArtistHeadshotsReviews}
        title="Trusted by 1,600+ Makeup Artists"
        highlight="1,600+"
        subtitle="Read reviews from makeup artists using our headshots for portfolios, booking platforms, and social media profiles."
      />
      <MakeupArtistBenefitsSection
        title="Boost up to 3× More Client Bookings and Brand Collaborations"
        highlight="3× More"
        description="Look as polished as your work — across portfolios, booking sites, and social profiles."
      />
      <GalleryReviewsSection
        category="makeup-artist"
        title="Makeup Artist Headshots"
        highlight="Makeup Artist"
        subtitle="See how our AI turns your selfies into studio-quality makeup artist headshots — in minutes."
        description="They look like a high-end studio shoot-but they're 100% AI-generated from your selfies."
      />
      <PricingSection
        pricingDetails={makeupArtistPricing}
        title="Makeup Artist Headshots — Over 90% Less Than Studio Prices"
        description="Get studio-quality makeup artist headshots — without the $500+ cost."
        highlight="90% Less"
      />
      ...
      />
      <FAQSection
        categories={makeupartistFaqCategories}
      ...
      <CTASection
        category="makeup-artist"
        title="Your Studio-Quality Makeup Artist Headshots Are Minutes Away"
        highlight="Makeup Artist Headshots"
        ctaText="Get My Headshots Now"
      />
