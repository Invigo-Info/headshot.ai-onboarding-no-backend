...
// UI components for the esthetician headshots landing page.
...
import EstheticianBenefitsSection from "@/components/landing-page/esthetician-headshots/esthetician-benefits-section";
import { FAQSection } from "@/components/landing-page/faq-section";

// Static data and utility functions for the page content.
import { estheticianHeadshotsReviews } from "@/data/reviews";
import { estheticianPricing } from "@/data/one-time-pricing-details";
import { getLogosBySlug } from "@/data/trusted-logos";

const { logos } = getLogosBySlug("esthetician");

const keypoints = ["100% money-back", "Fully private & secure"];

// Custom steps data for Esthetician headshots - Updated content
const estheticianFaqCategories = [
  {
    category: "What Are AI Esthetician Headshots?",
    questions: [
      {
        question: "What is an esthetician headshot?",
        answer:
          "An esthetician headshot is a professional shoulders-up photo used on spa websites, booking platforms, social media, and other beauty industry materials.",
      },
      {
        question: "Why do esthetician headshots matter?",
        answer:
          "They shape first impressions, build trust, and help you attract clients, bookings, and career opportunities.",
      },
      {
        question: "What is an AI esthetician headshot?",
        answer:
          "It's a professional esthetician headshot created from your casual selfies using Headshot.AI.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Esthetics students, licensed estheticians, medical estheticians, spa owners, skincare specialists, and beauty entrepreneurs.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Yes. You can select one or more backgrounds: studio, spa and treatment room, outdoor.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question: "What packages does Headshot.AI offer for estheticians?",
        answer:
  ...
  },
  {
    ...
    questions: [
      {
        question: "Where can I use my esthetician headshots?",
        answer:
          "Spa websites, booking platforms, LinkedIn, Google Business profiles, social media, business cards, brochures, treatment menus, and press features.",
      },
      {
...
const estheticianSteps: StepData[] = [
  {
    number: 1,
    title: "Choose Your Background",
    description:
      "Select one or more backgrounds: studio, spa and treatment room, outdoor.",
    images: [
      "/assets/landing-page/esthetician/how-it-works/step-1/background/1.studio.webp",
      "/assets/landing-page/esthetician/how-it-works/step-1/background/2.spa-and-treatment-room.webp",
      "/assets/landing-page/esthetician/how-it-works/step-1/background/3.outdoor.webp",
    ],
    labels: ["Studio", "Spa and Treatment Room", "Outdoor"],
  },
  {
    number: 2,
    ...
    images: [
      "/assets/landing-page/esthetician/how-it-works/step-2/1.webp",
      "/assets/landing-page/esthetician/how-it-works/step-2/2.webp",
      "/assets/landing-page/esthetician/how-it-works/step-2/3.webp",
    ],
  },
  {
    number: 3,
    ...
    description:
      "In under 15 minutes, our AI turns your selfies into studio-quality esthetician headshots with professional attire and the backgrounds you've chosen.",
    images: ["/assets/landing-page/esthetician/how-it-works/step-3/1.webp"],
  },
  {
    number: 4,
    title: "Download Your Headshots",
    description:
      "Review your gallery of 150 esthetician headshots and download your favorites for instant use.",
    images: [
      "/assets/landing-page/esthetician/how-it-works/step-4/1.webp",
      "/assets/landing-page/esthetician/how-it-works/step-4/2.webp",
      "/assets/landing-page/esthetician/how-it-works/step-4/3.webp",
      "/assets/landing-page/esthetician/how-it-works/step-4/4.webp",
      "/assets/landing-page/esthetician/how-it-works/step-4/5.webp",
      "/assets/landing-page/esthetician/how-it-works/step-4/6.webp",
    ],
  },
];
...
export const metadata = createPageMetadata({
  title: "#1 AI Esthetician Headshot Generator | 15 Minutes",
  description:
    "Turn your selfies into studio quality esthetician headshots. Perfect for spa websites, LinkedIn and social media. Rated 4.9/5 by thousands. Get yours now.",
  canonicalPath: "/esthetician-headshots",
});

export default function EstheticianHeadshotsPage() {
  return (
    <main className="flex flex-col space-y-24 sm:space-y-32 ">
      <HeroSection
        badgeText="#1 AI ESTHETICIAN HEADSHOT GENERATOR"
        title="Get Professional Esthetician Headshots in 15 Minutes"
        highlight="15 Minutes"
        description="Turn your casual selfies into studio-quality esthetician headshots that look exactly like you. Over 90% less than studio prices."
        ctaText="Get My Headshots Now"
        logos={logos}
        keypoints={keypoints}
        category="esthetician"
        trustedByText="Over 78,900 AI headshots generated for 900+ estheticians"
        trustedByTexthighlight={["78,900", "900+"]}
        usedByText="Used by estheticians across the beauty & wellness industry"
        showRating={true}
      />
      <HowItWorksSection
        mainTitle="Casual Selfies to Studio-Quality Esthetician Headshots"
        highlight="Selfies to Studio-Quality"
        subtitle="No photoshoot. No dressing up. Just four simple steps."
        steps={estheticianSteps}
      />
      <ReviewsSection
        reviews={estheticianHeadshotsReviews}
        title="Trusted by 900+ Estheticians"
        highlight="900+"
        subtitle="Read reviews from estheticians using our headshots for spa websites, booking platforms, and social media profiles."
      />
      <EstheticianBenefitsSection
        title="Increase up to 2× More Client Bookings and Referrals"
        highlight="2× More"
        description="Build trust before clients even walk in — across booking sites and social profiles."
      />
      <GalleryReviewsSection
        category="esthetician"
        title="Esthetician Headshots"
        highlight="Esthetician"
        subtitle="See how our AI turns your selfies into studio-quality esthetician headshots — in minutes."
        description="They look like a high-end studio shoot-but they're 100% AI-generated from your selfies."
      />
      <PricingSection
        pricingDetails={estheticianPricing}
        title="Esthetician Headshots — Over 90% Less Than Studio Prices"
        description="Get studio-quality esthetician headshots — without the $500+ cost."
        highlight="90% Less"
      />
      ...
      />
      <FAQSection
        categories={estheticianFaqCategories}
      ...
      <CTASection
        category="esthetician"
        title="Your Studio-Quality Esthetician Headshots Are Minutes Away"
        highlight="Esthetician Headshots"
        ctaText="Get My Headshots Now"
      />
