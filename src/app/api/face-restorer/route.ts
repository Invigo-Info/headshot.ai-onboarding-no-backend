 ...
 if(!userImageUrl) {
  ...
  /*
    ...
    */
    ...
    const result = (await replicate.run("sczhou/codeformer:cc4956dd26fa5a7185d5660cc9100fab1b8070a1d1654a8bb5eb6d443b020bb2", { input })) as ReplicateImageOutput;
   ...
   await supabase.rpc('use_editor_credit', {
    ...
    const errorMessage = error instanceof Error ? error.message : "An unknown error occurred while generating the face enhancer";
    console.error(error, errorMessage);

    return new Response(
      JSON.stringify({ error: "An unknown error occurred while generating the face enhancer" }),
      { status: 500 }
    );
  }
}
