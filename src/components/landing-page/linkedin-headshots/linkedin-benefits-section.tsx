...
import { Linkedin, Award, Users, Monitor } from "lucide-react";
...
const categories = [
  {
    ...
    content: [
      {
        label: "Your profile photo is your first impression",
        text: "Clean, studio-quality headshots with the right professional look help you get up to 14× more views and connection requests.",
      },
      {
        label: "Get noticed by recruiters faster",
        text: "Realistic, sharp, job-ready headshots make you stand out in search results and land on shortlists faster.",
      },
    ],
    Visual: OnlineProfilesVisual, // Replace with OnlineProfilesVisual
  },
  {
    ...
    content: [
      {
        label: 'Nail the "Open to Work" frame',
        text: "Natural, true-to-you photos make the Open to Work frame feel human and give recruiters a real reason to click first.",
      },
      {
        label: "Make a strong case for promotions",
        text: "High-quality, executive-style headshots signal you're serious about growth and ready for bigger roles.",
      },
      {
        label: "Turn cold outreach into warm replies",
        text: "Friendly, real-looking faces in studio-quality lighting build trust and turn more cold outreach into warm replies.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Be memorable after events and meetings",
        text: "A realistic, consistent headshot helps people recognize you instantly after events and remember why they liked you.",
      },
      {
        label: "Stay consistent across every platform",
        text: "Multiple looks and crops let your LinkedIn, email, Slack, resume, and other tools all show the same polished image of you.",
      },
    ],
