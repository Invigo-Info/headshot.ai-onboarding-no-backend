...
import { Monitor, Linkedin, TrendingUp, Presentation } from "lucide-react";
...
const categories = [
  {
    ...
    content: [
      {
        label: "Company Websites & Leadership Pages",
        text: "Highlight your leadership with a clean, modern photo on your company site, About page, and team pages.",
      },
      {
        label: "LinkedIn & Business Networks",
        text: "Stand out on LinkedIn, Crunchbase, AngelList, and executive directories with a sharp, credible image that attracts more clicks and connection requests.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Investor & Board-Facing Materials",
    icon: <TrendingUp className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Pitch Decks & Investor Presentations",
        text: "Add a professional photo to your pitch deck and investor materials so VCs and angels see a credible leader before you even speak.",
      },
      {
        label: "Board Reports & Annual Reports",
        text: "Use polished headshots in board materials, shareholder reports, and company announcements that reflect your leadership presence.",
      },
      {
        label: "Press Releases & Funding Announcements",
        text: "Look credible in funding announcements, acquisition news, and company milestones that media outlets actually want to cover.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Marketing, Media & Speaking",
    icon: <Presentation className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Business Cards & Executive Materials",
        text: "Upgrade business cards, executive bios, and company brochures with one polished photo that feels on-brand everywhere.",
      },
      {
        label: "Conferences, Panels & Speaking Engagements",
        text: "Use your headshot on event websites, speaker profiles, programs, and slide decks so you look professional before you take the stage.",
      },
      {
        label: "Media Features, Podcasts & Press Kits",
        text: "Look credible in Forbes, Inc., TechCrunch, business podcasts, and press features with a headshot editors actually want to use.",
      },
      {
        label: "Email Signatures & Executive Communications",
        text: "Add your photo to emails, proposals, and updates so partners, clients, and investors recognize you instantly.",
      },
    ],
