...
import { Monitor, Linkedin, Presentation, TrendingUp } from "lucide-react";
...
const categories = [
  {
    title: "Leadership & Company Profiles",
    icon: <Monitor className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Company Websites & Executive Bios",
        text: "Highlight your leadership presence with a polished, modern photo on your company site, about page, and team pages.",
      },
      {
        label: "LinkedIn & Professional Networks",
        text: "Stand out on LinkedIn and industry platforms with a sharp, credible image that attracts connections, recruiters, and opportunities.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Board & Investor Touchpoints",
    icon: <TrendingUp className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Board Presentations & Annual Reports",
        text: "Add your photo to board materials, annual reports, and investor decks so stakeholders see a consistent, professional image.",
      },
      {
        label: "Investor Relations & Pitch Decks",
        text: "Build trust with VCs, private equity, and angel investors with a headshot that projects confidence and competence.",
      },
      {
        label: "Press Releases & Media Kits",
        text: "Look credible in news features, press releases, and media kits with a headshot journalists actually want to use.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Speaking, Media & Thought Leadership",
    icon: <Presentation className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Conferences & Keynote Speaking",
        text: "Use your headshot on event websites, programs, speaker profiles, and slide decks so you look professional before you're on stage.",
      },
      {
        label: "Podcasts, Interviews & Media Appearances",
        text: "Present a polished image for podcast features, video interviews, and media appearances that builds audience trust.",
      },
      {
        label: "Industry Publications & Bylines",
        text: "Look authoritative in trade journals, business publications, op-eds, and thought leadership pieces.",
      },
      {
        label: "Books, Courses & Personal Brand Materials",
        text: "Perfect for author bios, online courses, coaching profiles, and personal brand websites.",
      },
    ],
