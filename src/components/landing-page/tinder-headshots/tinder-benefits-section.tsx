...
const categories = [
    ...
    content: [
      {
        ...
        text: "On Tinder, first impressions happen in milliseconds. Natural lighting, flattering angles, and genuine-looking photos make people want to match with you.",
      },
      {
        label: "Look interesting enough to message first",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "Multiple looks — casual, adventurous, polished — let people get a feel for who you are just by scrolling your Tinder profile.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      {
        label: "Built specifically for Tinder's format",
        text: "Photos are automatically sized and optimized for Tinder's display. Look your best on mobile — where 100% of swiping happens.",
      },
    ],
