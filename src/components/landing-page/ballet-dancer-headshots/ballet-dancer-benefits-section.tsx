...
const categories = [
  {
    ...
    content: [
      {
        label: "Company Auditions & Open Calls",
        text: "Make a strong first impression with a polished headshot that shows artistic directors you're ready.",
      },
      {
        label: "Summer Intensives & Trainee Programs",
        text: "Stand out in competitive applications for ABT, SAB, PNB, Houston Ballet, and other top programs.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Company & Competition Materials",
    icon: <BadgeCheck className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Roster Pages & Playbills",
        text: "Look your best on company bios, Nutcracker cast lists, and performance programs.",
      },
      {
        label: "YAGP, Prix de Lausanne & Competitions",
        text: "Present yourself with a polished image that judges and scouts remember.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Resumes & Online Presence",
    icon: <Presentation className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Ballet Resumes & Headshot-Resume Combos",
        text: "Upgrade your resume with a headshot that looks stage-ready at a glance.",
      },
      {
        label: "Instagram & Personal Branding",
        text: "Build your following with polished imagery that attracts artistic directors and opportunities.",
      },
    ],
