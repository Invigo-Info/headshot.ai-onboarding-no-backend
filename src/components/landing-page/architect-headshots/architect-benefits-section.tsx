...
const categories = [
  {
    ...
    content: [
      {
        label: "Firm Websites & Portfolio Pages",
        text: "Make a strong impression on your firm site, team page, and online portfolio where clients evaluate your work.",
      },
      {
        label: "Archinect, Architizer, Houzz & AIA Directories",
        text: "Stand out on architecture platforms and directories with a sharp, credible image that attracts more project inquiries.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Client & Project Touchpoints",
    icon: <BadgeCheck className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "RFPs, RFQs & Project Proposals",
        text: "Add your photo to proposal documents and pitch decks so selection committees see a face behind your design vision.",
      },
      {
        label: "NCARB Profile & State Licensing Boards",
        text: "Use your headshot for AIA membership, NCARB records, and state license renewals so you look polished in every official context.",
      },
      {
        label: "Project Team Introductions",
        text: "Put a face to your name in client presentations and team bios to build trust before the first design meeting.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Business Cards & Firm Announcements",
        text: "Upgrade business cards, new partner announcements, and firm brochures with one polished photo that feels on-brand.",
      },
      {
        label: "Design Conferences & Guest Lectures",
        text: "Use your headshot on AIA event programs, speaker profiles, and university guest lecture announcements.",
      },
      {
        label: "ArchDaily, Dezeen & Design Publications",
        text: "Look credible in architecture features, project spotlights, and press releases with a headshot editors want to use.",
      },
      {
        label: "Award Submissions & Career Materials",
        text: "Ideal for AIA Awards, design competitions, job applications, and partnership announcements so you look prepared at a glance.",
      },
    ],
