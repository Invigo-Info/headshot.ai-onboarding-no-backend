    ...
    content: [
      {
        ...
        text: "Stand out on LinkedIn, Sales Navigator, and professional networks with a sharp, credible image that attracts more connection requests and responses.",
      },
      {
        label: "Company Websites & Team Pages",
        text: "Highlight your experience with a clean, modern photo on your company site, bio page, and leadership team pages.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Client & Prospect-Facing Touchpoints",
    icon: <Users className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Outreach",
        text: "Add your photo to emails, proposals, and follow-ups so prospects recognize you instantly and feel more comfortable replying.",
      },
      {
        label: "CRM Profiles & Sales Tools",
        text: "Use your headshot in Salesforce, HubSpot, Outreach, and other sales tools so your profile looks polished in every interaction.",
      },
      {
        label: "Sales Decks & Proposals",
        text: "Add your photo to pitch decks, proposals, and case studies so prospects see a real person behind the numbers.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Events, Recognition & Career",
    icon: <Award className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Business Cards & Printed Materials",
        text: "Upgrade business cards, brochures, and leave-behinds with one polished photo that feels on-brand everywhere.",
      },
      {
        label: "Trade Shows, Conferences & SKOs",
        text: "Use your headshot on event badges, speaker profiles, booth materials, and sales kickoff decks so you look professional before you shake a hand.",
      },
      {
        label: "Internal Announcements & Promotions",
        text: "Look polished in company newsletters, promotion announcements, President's Club recognitions, and internal leadership spotlights.",
      },
      {
        label: "Resumes & Career Growth",
        text: "Ideal for LinkedIn, job applications, and internal promotion materials so you look ready to lead at a glance.",
      },
    ],
