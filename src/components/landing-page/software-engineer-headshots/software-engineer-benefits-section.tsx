...
const categories = [
    ...
    content: [
      {
        ...
        text: "Stand out on LinkedIn with a sharp, credible image that attracts more recruiter messages and connection requests.",
      },
      {
        label: "GitHub & Developer Portfolios",
        text: "Put a professional face to your code. A polished headshot on GitHub and your portfolio signals you take your work seriously.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Company Profiles & Team Pages",
        text: "Highlight your experience with a clean, modern photo on your company's website and team page.",
      },
      {
        label: "Resumes, Applications & Interview Materials",
        text: "Look prepared and professional on job applications, cover letters, and any materials you share with hiring teams.",
      },
      {
        label: "Slack, Teams & Internal Directories",
        text: "Use your headshot for workplace tools and internal systems so you look polished in every professional context.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Tech Conferences & Meetups",
        text: "Use your headshot on event websites, speaker profiles, and slide decks so you look professional before you step on stage.",
      },
      {
        label: "Blog Posts, Publications & Media",
        text: "Look credible in tech blogs, online articles, podcasts, and press features with a headshot editors actually want to use.",
      },
      {
        label: "Open Source Contributions",
        text: "Add a professional photo to your open source profiles. It builds trust and makes your contributions more memorable.",
      },
    ],
