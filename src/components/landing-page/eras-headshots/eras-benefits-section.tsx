...
const categories = [
  {
    ...
    content: [
      {
        label: "Your ERAS photo is your first impression",
        text: "A clear, polished headshot helps you look prepared and professional before anyone reads your personal statement or CV.",
      },
      {
        label: "Stand out in a crowded applicant pool",
        text: "Realistic, sharp, residency-appropriate headshots help you rise above thousands of applications competing for limited spots.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Look confident and approachable",
        text: "Natural lighting and balanced expression make you look like someone programs want on their team — and in their hospital.",
      },
      {
        label: "Match the expectations of program directors",
        text: "Clean backgrounds and proper framing follow ERAS norms, so nothing in your photo becomes a distraction or red flag.",
      },
      {
        label: "Strengthen your entire application",
        text: "A professional photo pulls together your CV, letters, and personal statement into a polished, cohesive package.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Be memorable during ranking season",
        text: "A consistent, realistic headshot helps committees remember you clearly when they review hundreds of candidates at once.",
      },
      {
        label: "Use one photo across every platform",
        text: "Multiple crops let your ERAS, LinkedIn, email signature, and residency interviews all show the same polished, consistent you.",
      },
    ],
