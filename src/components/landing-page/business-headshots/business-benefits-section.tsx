...
import { Monitor, Linkedin, Mail, Briefcase } from "lucide-react";
...
const categories = [
    ...
    content: [
      {
        ...
        text: "Stand out with a sharp, credible image that attracts more profile views, connection requests, and recruiter messages.",
      },
      {
        label: "Company Websites & Team Pages",
        text: "Highlight your role with a clean, modern photo on your bio, team page, and About Us section.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Email Signatures & Internal Profiles",
        text: "Add your photo to emails and company systems so colleagues and clients recognize you instantly.",
      },
      {
      ...
      {
        label: "Proposals, Pitch Decks & Client Materials",
        text: "Put a face to your name on proposals and presentations to build trust before the meeting even starts.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Internal Profiles & Company Directories",
        text: "Look polished on employee portals, org charts, and internal communications where your team sees you every day.",
      },
      {
        label: "Conferences, Webinars & Speaking Engagements",
        text: "Use your headshot on event websites, speaker profiles, and slide decks so you look professional before you're on stage.",
      },
      {
        label: "Industry Directories & Publications",
        text: "Look credible in trade publications, industry directories, and press features with a headshot editors actually want to use.",
      },
    ],
