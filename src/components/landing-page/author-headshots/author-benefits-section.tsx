...
const categories = [
  {
    ...
    content: [
      {
        label: "Book Jackets & Back Covers",
        text: "Make a strong first impression with a polished author photo on your paperback, hardcover, and ebook covers.",
      },
      {
        label: "Amazon Author Central & Goodreads",
        text: "Stand out on Amazon, Goodreads, and BookBub with a sharp, credible image that attracts more clicks and followers.",
      },
      {
        label: "Publisher Submissions & Agent Queries",
        text: "Look professional in your query letters and publisher submissions with a headshot that shows you're ready.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Author Website & Blog",
        text: "Build trust with a clean, modern photo on your homepage, about page, and blog sidebar.",
      },
      {
        label: "Social Media Profiles",
        text: "Create a consistent, recognizable look across Instagram, Twitter/X, Facebook, TikTok, and LinkedIn.",
      },
      {
        label: "Email Newsletters & Reader Magnets",
        text: "Add your photo to newsletters and lead magnets so readers recognize and connect with you.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Marketing, Events & Media",
    icon: <Presentation className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Book Signings & Author Events",
        text: "Use your headshot on event posters, bookstore displays, and conference programs to look professional.",
      },
      {
        label: "Podcast Appearances & Interviews",
        text: "Provide media-ready photos for podcast graphics, YouTube thumbnails, and interview features.",
      },
      {
        label: "Press Kits & Media Features",
        text: "Look credible in author spotlights, book reviews, and media kits with a headshot editors want to use.",
      },
      {
        label: "Speaking Engagements & Workshops",
        text: "Use your headshot on event pages, slide decks, and speaker bios to establish authority.",
      },
    ],
