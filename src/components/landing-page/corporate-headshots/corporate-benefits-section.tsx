...
import { Monitor, Linkedin, MessageSquare, Briefcase } from "lucide-react";
    ...
    content: [
      {
        ...
        text: "Look polished and consistent on your company's About page, team directory, and internal profiles.",
      },
      {
        label: "LinkedIn & Professional Networks",
        text: "Stand out with a sharp, credible image that attracts recruiters, clients, and connection requests.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Add your photo to emails, business cards, and proposals so contacts recognize you instantly.",
      },
      {
        label: "Internal Systems & Employee Directories",
        text: "Look professional in company systems, Slack, Teams, and internal directories.",
      },
      {
        label: "Virtual Meeting Profiles",
        text: "Upgrade your Zoom, Teams, and Google Meet profile pictures for a polished first impression on video calls.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Stand out to hiring managers with a professional headshot that shows you're serious about your career.",
      },
      {
        label: "Conferences & Speaking Engagements",
        text: "Use your headshot on event websites, speaker bios, slide decks, and conference materials.",
      },
      {
        label: "Press Features & Publications",
        text: "Look credible in industry publications, blog posts, press releases, and media features.",
      },
      {
        label: "Personal Websites & Portfolios",
        text: "Present yourself professionally on your personal brand website, portfolio, or freelance profiles.",
      },
    ],
