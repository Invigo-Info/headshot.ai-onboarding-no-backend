...
import { Linkedin, PartyPopper, Briefcase, Gift } from "lucide-react";
...
const categories = [
  {
    title: "Announcements & Keepsakes",
    icon: <Gift className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Graduation Announcements & Cards",
        text: "Share the news with a beautiful headshot on printed and digital announcements that family and friends will treasure.",
      },
      {
        label: "Yearbooks & Senior Pages",
        text: "Stand out in your yearbook or senior memory page with a professional photo that captures this milestone.",
      },
      {
        label: "Framed Prints & Family Keepsakes",
        text: "Give grandparents, parents, and loved ones a frame-worthy portrait they'll proudly display for years.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Start your career with a polished headshot that shows confidence and professionalism from day one.",
      },
      {
        label: "Resumes & Job Applications",
        text: "Add a professional photo to applications and resumes that makes a strong first impression with hiring managers.",
      },
      {
        label: "Graduate School Applications",
        text: "Include a sharp, professional headshot with your grad school or fellowship applications.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Social Media Announcements",
        text: "Post your achievement on Instagram, Facebook, and Twitter with a stunning photo that gets the likes you deserve.",
      },
      {
        label: "Party Invitations & Thank You Cards",
        text: "Use your headshot on graduation party invites and thank-you notes for a personal, polished touch.",
      },
      {
        label: "Digital Portfolios & Personal Websites",
        text: "Showcase your achievement on personal sites, portfolios, and about pages with a professional graduation photo.",
      },
    ],
