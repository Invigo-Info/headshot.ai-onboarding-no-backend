...
import { Linkedin, Briefcase, TrendingUp, Camera } from "lucide-react";
...
const categories = [
  {
    title: "Agency & Portfolio Essentials",
    icon: <Briefcase className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Agency Submissions & Open Calls",
        text: "Submit professional digitals that make casting directors stop scrolling. Clean, well-lit headshots get you noticed.",
      },
      {
        label: "Comp Cards & Zed Cards",
        text: "Create stunning comp cards with variety — different backgrounds, expressions, and vibes — all from one package.",
      },
      {
        label: "Model Portfolio & Book Updates",
        text: "Keep your portfolio current without booking expensive test shoots every few months.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Casting & Booking Platforms",
    icon: <Camera className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Model Mayhem & Casting Networks",
        text: "Stand out on casting sites with headshots that look polished and professional — not like bathroom selfies.",
      },
      {
        label: "Instagram & Social Media",
        text: "Build a cohesive, professional feed that attracts brands, agencies, and direct clients.",
      },
      {
        label: "Direct Client Pitches",
        text: "Send headshots to brands and businesses that make them want to work with you before they've even met you.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "New Face Portfolios",
        text: "Build a complete, professional portfolio without spending thousands on initial test shoots.",
      },
      {
        label: "Mother Agency Submissions",
        text: "Impress mother agencies with headshots that show you're serious about your modeling career.",
      },
      {
        label: "Brand Collaborations & Sponsorships",
        text: "Look professional enough for brand partnerships, even if you're just starting out.",
      },
    ],
