...
const categories = [
  {
    ...
    content: [
      {
        label: "Instagram, TikTok & Social Media",
        text: "Your profile photo is the first thing people see. A sharp, professional image helps you stand out and get more followers, DMs, and inquiries.",
      },
      {
        label: "Gym Websites & Trainer Bio Pages",
        text: 'Look polished on your gym\'s website, staff page, and "Meet Our Trainers" section so new members want to train with you.',
      },
      {
        label: "Fitness Apps & Booking Platforms",
        text: "Stand out on Mindbody, ClassPass, Trainerize, TrueCoach, and other apps where clients scroll through trainers and pick who looks most credible.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "WhatsApp, iMessage & Text Profile Photos",
        text: "Update your profile photo on messaging apps so clients recognize you instantly and feel connected before you even meet.",
      },
      {
        label: 'Gym Posters & "Meet the Trainers" Boards',
        text: "Feature your headshot on gym wall displays, class schedules, and trainer boards so members see your face and remember your name.",
      },
      {
        label: "Business Cards & Referral Cards",
        text: "Hand out business cards with a professional photo that sticks in people's minds and makes referrals easier.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Growing Your Training Business",
    icon: <TrendingUp className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Online Coaching Websites & Landing Pages",
        text: "If you sell programs online, a trustworthy headshot helps visitors feel confident buying from you — even if they've never met you.",
      },
      {
        label: "LinkedIn & Professional Networking",
        text: "Connect with gym owners, fitness brands, and other trainers with a profile photo that looks polished and career-ready.",
      },
      {
        label: "Fitness Challenges & Group Programs",
        text: "Promote your 6-week challenges, boot camps, or group training with a professional photo that makes your marketing look legit.",
      },
    ],
