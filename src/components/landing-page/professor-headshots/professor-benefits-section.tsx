...
import { Monitor, Linkedin, Award, Users } from "lucide-react";
...
const categories = [
  {
    ...
    content: [
      {
        label: "Faculty Pages & Department Websites",
        text: "Highlight your expertise with a clean, modern photo on your faculty page, department site, and university profiles.",
      },
      {
        label: "LinkedIn & Academic Networks",
        text: "Stand out on LinkedIn, ResearchGate, Academia.edu, and Google Scholar with a sharp, credible image that attracts more connections.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Student & Peer-Facing Touchpoints",
    icon: <Users className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Student Communications",
        text: "Add your photo to emails, syllabi, and course pages so students recognize you instantly and feel more comfortable reaching out.",
      },
      {
        label: "University IDs, Badges & Portal Profiles",
        text: "Use your headshot for professional IDs, learning management systems, and internal portals so you look polished in every official context.",
      },
      {
        label: "Course Catalogs & Registration Pages",
        text: "Put a face to your name on course descriptions and registration pages to build trust and increase enrollment.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Research, Media & Career",
    icon: <Award className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Conference Profiles & Speaking Engagements",
        text: "Use your headshot on conference websites, programs, speaker profiles, and presentation slides so you look professional before you're on stage.",
      },
      {
        label: "Research Publications & Grant Applications",
        text: "Look credible in journal author bios, research profiles, and grant submissions with a headshot that conveys expertise.",
      },
      {
        label: "Media Features & Press Kits",
        text: "Look credible in university press releases, news interviews, and expert commentary with a headshot media outlets actually want to use.",
      },
      {
        label: "CVs, Tenure Packets & Job Applications",
        text: "Ideal for academic CVs, tenure portfolios, job market materials, and postdoc applications so you look prepared at a glance.",
      },
    ],
