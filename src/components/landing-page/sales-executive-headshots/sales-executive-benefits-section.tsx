    ...
    content: [
      {
        ...
        text: "Stand out with a sharp, professional photo that attracts more profile views, connection accepts, and InMail replies from your target prospects.",
      },
      {
        label: "Company Website & Team Pages",
        text: "Look polished and consistent with your team on your company's About page, team directory, and sales bios.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Prospect-Facing Touchpoints",
    icon: <Users className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Sales Outreach",
        text: "Add your photo to email signatures, cold outreach, and follow-ups so prospects see a real person — not just another automated message.",
      },
      {
        label: "CRM & Sales Platforms",
        text: "Use your headshot in Salesforce, HubSpot, Gong, Outreach, and other tools so your face shows up everywhere you engage with prospects.",
      },
      {
        label: "Video Sales Calls & Webinars",
        text: "Use your headshot as your Zoom, Teams, or Google Meet profile photo so you look professional even before the camera turns on.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Events & Career Growth",
    icon: <Award className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Business Cards & Leave-Behinds",
        text: "Upgrade your business cards, one-pagers, and proposal docs with one polished photo that reinforces your personal brand.",
      },
      {
        label: "Trade Shows & Industry Conferences",
        text: "Use your headshot on event badges, booth materials, and attendee profiles so you look sharp when meeting prospects in person.",
      },
      {
        label: "Sales Awards & President's Club",
        text: "Look great in award announcements, leaderboard features, President's Club recognition, and company posts that celebrate your wins.",
      },
      {
        label: "Job Applications & Promotions",
        text: "Perfect for sales job applications, internal promotion packets, and leadership bios so you stand out at every career stage.",
      },
    ],
