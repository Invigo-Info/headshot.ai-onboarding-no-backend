...
import { Monitor, Linkedin, Megaphone, FileText } from "lucide-react";
...
const categories = [
  {
    ...
    content: [
      {
        label: "Salon Websites & Team Pages",
        text: "Highlight your skills with a clean, modern photo on your salon's website, bio page, and team roster.",
      },
      {
        label: "Instagram, TikTok & Social Media",
        text: "Stand out on Instagram, TikTok, and Facebook with a sharp, professional image that attracts more followers and bookings.",
      },
      {
        label: "Booking Platforms & Apps",
        text: "Look polished on StyleSeat, Vagaro, Booksy, Fresha, GlossGenius, and other booking platforms where clients choose their nail tech.",
      },
      {
        label: "Yelp, Google & Review Sites",
        text: "Look credible on Yelp, Google Business, and local directories where potential clients search for nail technicians.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Business Cards & Salon Flyers",
        text: "Upgrade business cards and salon flyers with one polished photo that feels on-brand everywhere you hand them out.",
      },
      {
        label: "Client Referral Cards & Thank You Notes",
        text: "Add your photo to referral cards and thank you notes so clients remember you and spread the word.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Portfolio & Nail Art Showcases",
        text: "Pair your stunning nail art photos with a professional headshot that shows the talented artist behind the work.",
      },
      {
        label: "Wedding & Event Vendor Profiles",
        text: "Look polished on The Knot, WeddingWire, and Thumbtack where brides and event planners search for nail services.",
      },
      {
        label: "Gift Cards & Loyalty Cards",
        text: "Add your photo to gift certificates and loyalty cards so clients connect your face with your brand every time.",
      },
      {
        label: "Salon Signage & Station Displays",
        text: "Use your headshot on your station display, salon window, or front desk sign so clients know exactly who they're booking.",
      },
    ],
