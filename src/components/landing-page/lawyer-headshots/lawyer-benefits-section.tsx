...
import { Monitor, Linkedin, BadgeCheck, Presentation } from "lucide-react";
...
const categories = [
  {
    ...
    content: [
      {
        label: "Law Firm Websites & Bio Pages",
        text: "Highlight your experience with a clean, modern photo on your firm site, bio page, and team pages.",
      },
      {
        label: "LinkedIn & Legal Directories",
        text: "Stand out on LinkedIn, Avvo, Justia, Martindale, and bar directories with a sharp, credible image that attracts more clicks.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Client & Court-Facing Touchpoints",
    icon: <BadgeCheck className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Client Communications",
        text: "Add your photo to emails, proposals, and updates so clients recognize you instantly and feel more comfortable replying.",
      },
      {
        label: "Court Badges, Bar Credentials & ID Cards",
        text: "Use your headshot for professional IDs, bar profiles, and internal systems that display your image so you look polished in every official context.",
      },
      {
        label: "Client Intake & Consultation Pages",
        text: "Put a face to your name on intake forms and booking pages to build trust and increase completed consultations.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Marketing, Media & Career",
    icon: <Presentation className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Business Cards & Printed Materials",
        text: "Upgrade business cards, brochures, and firm announcements with one polished photo that feels on-brand everywhere.",
      },
      {
        label: "Conferences, CLEs & Speaking Engagements",
      ...
      {
        label: "Publications, Press & Media Kits",
        text: "Look credible in bar journals, legal blogs, news features, and press releases with a headshot editors actually want to use.",
      },
      {
        label: "Resumes & Career Materials",
        text: "Ideal for law school résumés, lateral applications, clerkships, and promotion packets so you look prepared at a glance.",
      },
    ],
