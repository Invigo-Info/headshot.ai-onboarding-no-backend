...
const categories = [
  {
    ...
    content: [
      {
        label: "Portfolio Websites & About Pages",
        text: "Make a strong first impression with a photo that matches the quality of your room reveals and project galleries.",
      },
      {
        label: "Houzz Pro & Design Platforms",
        text: 'Get more "Contact Designer" clicks on Houzz, Decorilla, Havenly, and Thumbtack with an image that builds instant trust.',
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Design Proposals & Mood Boards",
        text: "Add your photo to client presentations and mood board decks so homeowners feel connected before the first site walk.",
      },
      {
        label: "Consultation Booking Pages",
        text: "Put a face to your name on scheduling pages so potential clients feel comfortable booking that discovery call.",
      },
      {
        label: "Trade Account & Vendor Profiles",
        text: "Look polished on your to-the-trade showroom accounts, vendor portals, and designer discount registrations.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Business Cards & Lookbooks",
        text: "Upgrade business cards and project leave-behinds with one refined photo that matches your design aesthetic.",
      },
      {
        label: "Designer Showhouses & Home Tours",
        text: "Use your headshot on showhouse programs, home tour materials, and design event signage so attendees recognize you.",
      },
      {
        label: "Magazine Features",
        text: "Look credible when Architectural Digest, Elle Decor, or local lifestyle magazines run your project — with a headshot editors want to publish.",
      },
    ],
