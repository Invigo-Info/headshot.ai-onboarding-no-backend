...
import { Monitor, Linkedin, Briefcase, Heart } from "lucide-react";
...
const categories = [
  {
    ...
    content: [
      {
        label: "Hospital Websites & Staff Pages",
        text: "Highlight your experience with a clean, modern photo on your hospital site, department page, and team listings.",
      },
      {
        label: "LinkedIn & Nursing Job Boards",
        text: "Stand out on LinkedIn, Indeed, Nurse.com, and healthcare job boards with a sharp, credible image that attracts more clicks and callbacks.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Patient & Professional Touchpoints",
    icon: <Heart className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Team Communications",
        text: "Add your photo to emails, internal directories, and team updates so patients and colleagues recognize you instantly.",
      },
      {
        label: "Hospital IDs, Badges & Credentials",
        text: "Use your headshot for professional IDs, nursing credentials, and internal systems so you look polished in every official context.",
      },
      {
        label: "Patient Portal & Appointment Pages",
        text: "Put a face to your name on patient portals and scheduling pages to build trust before patients even meet you.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Upgrade your resume, cover letter, and application materials with one polished photo that makes a strong first impression with recruiters.",
      },
      {
        label: "Travel Nursing Profiles",
        text: "Stand out on travel nursing platforms like Vivian, Nomad, and Aya with a professional image that gets you noticed for top assignments.",
      },
      {
        label: "Nursing School & Certification Applications",
        text: "Look prepared and professional on applications for advanced degrees, specialty certifications, or fellowship programs.",
      },
      {
        label: "Professional Nursing Organizations",
        text: "Use your headshot for ANA membership profiles, specialty nursing associations, and professional networking platforms.",
      },
    ],
