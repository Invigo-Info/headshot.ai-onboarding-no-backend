...
const categories = [
  {
    ...
    content: [
      {
        label: "Practice Websites & Team Pages",
        text: 'Show patients who they\'ll trust with their smile with a clean, modern photo on your bio and "Meet the Team" sections.',
      },
      {
        label: "Dental Directories & Review Sites",
        text: "Stand out on Healthgrades, Zocdoc, Vitals, RateMDs, and Google Business Profile with a sharp image that attracts more clicks.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Patient-Facing Touchpoints",
    icon: <Users className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Online Booking & New Patient Forms",
        text: "Put a face to your name on scheduling pages and intake forms to build trust and increase completed appointments.",
      },
      {
        label: "Appointment Reminders & Welcome Emails",
        text: "Add your photo to emails and texts so patients recognize you and feel comfortable before their visit.",
      },
      {
        label: "In-Office Displays & Operatory Screens",
        text: "Use your headshot on lobby screens and wall displays so patients feel familiar with you before sitting in the chair.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Credentialing & Career",
    icon: <Briefcase className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Insurance Panels & Provider Directories",
        text: "Use your headshot for insurance credentialing and network directories so you look polished in every official listing.",
      },
      {
        label: "State Dental Board & Association Profiles",
        text: "Look professional on licensing records, ADA profiles, and specialty association member pages.",
      },
      {
        label: "Resumes & Job Applications",
        text: "Ideal for associate positions, partnership opportunities, and DSO applications so you look prepared at a glance.",
      },
    ],
