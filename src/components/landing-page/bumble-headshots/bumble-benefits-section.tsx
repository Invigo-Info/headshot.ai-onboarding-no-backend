...
const categories = [
  {
    ...
    content: [
      {
        label: "Your photo decides who swipes right",
        text: "On Bumble, great first impressions matter. Natural lighting, flattering angles, and genuine-looking photos make people want to match with you.",
      },
      {
        label: "Look approachable enough to message",
        text: "Natural, well-lit photos build trust. You'll look like someone worth starting a conversation with — not just swiping past.",
      },
    ],
    ...
    content: [
      {
        ...
        text: 'Interesting backgrounds — cafés, travel spots, golden hour, city streets — give people an easy opener beyond just "hey."',
      },
      {
        label: "Show different sides of yourself",
        text: "Multiple looks — casual, adventurous, polished — let people get a feel for who you are just by scrolling your Bumble profile.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      {
        label: "Built specifically for Bumble's format",
        text: "Photos are automatically sized and optimized for Bumble's display. Look your best on mobile — where 90% of swiping happens.",
      },
    ],
