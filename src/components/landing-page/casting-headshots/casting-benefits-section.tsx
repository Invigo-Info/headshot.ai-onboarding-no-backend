...
export const categories = [
  {
    title: "Casting Platforms & Auditions",
    icon: <Film className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Actors Access, Backstage & Casting Networks",
        text: "Stand out in online submissions with a sharp, professional headshot that grabs attention in a crowded talent pool.",
      },
      {
        label: "Agent & Manager Submissions",
        text: "Make a strong first impression when submitting to agents and managers. A polished headshot shows you're serious about your career.",
      },
      {
        label: "In-Person Auditions & Self-Tape Thumbnails",
        text: "Walk into audition rooms with a headshot that actually looks like you, and use it as a clean self-tape thumbnail so casting directors recognize you instantly.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Industry Profiles & Directories",
    icon: <User className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "IMDb, Playbill & StarNow Profiles",
        text: "Keep your industry profiles updated with headshots that reflect your current look and casting range.",
      },
      {
        label: "Personal Actor Website",
        text: "Showcase your best self on your own site with gallery-worthy headshots that match your brand.",
      },
      {
        label: "Social Media & Reels",
        text: "Update Instagram, TikTok, and YouTube with a professional profile photo that boosts credibility and attracts followers.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Hand out professional cards at industry events, workshops, and showcases that leave a lasting impression.",
      },
      {
        label: "Showcase & Festival Programs",
        text: "Look polished in event programs, cast lists, and festival materials with a headshot that represents you well.",
      },
    ],
