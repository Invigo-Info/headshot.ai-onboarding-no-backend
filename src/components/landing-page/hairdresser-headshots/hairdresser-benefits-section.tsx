...
const categories = [
  {
    ...
    content: [
      {
        label: "Salon Websites & Bio Pages",
        text: "Show off your style with a clean, modern photo on your salon site, bio page, and team directory.",
      },
      {
        label: "Instagram, Booking Apps & Review Sites",
        text: "Stand out on Instagram, StyleSeat, Vagaro, Booksy, Yelp, and Google Business with a sharp, professional image that attracts more clicks and bookings.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Add your photo to emails, booking confirmations, and follow-ups so clients recognize you instantly and feel more connected.",
      },
      {
        label: "Booking & Consultation Pages",
        text: "Put a face to your name on booking pages and consultation forms to build trust and get more completed appointments.",
      },
      {
        label: "Business Cards & Printed Materials",
        text: "Upgrade business cards, salon flyers, and appointment cards with one polished photo that looks great everywhere.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Use your headshot across Instagram, TikTok, Facebook, and Pinterest so you look consistent and professional on every platform.",
      },
      {
        label: "Salon Promos & Local Advertising",
        text: "Look credible in salon ads, local magazines, and promotional materials with a headshot that makes you stand out.",
      },
      {
        label: "Resumes & Career Materials",
        text: "Ideal for job applications, salon portfolios, and promotion packets so you look polished and ready at a glance.",
      },
    ],
