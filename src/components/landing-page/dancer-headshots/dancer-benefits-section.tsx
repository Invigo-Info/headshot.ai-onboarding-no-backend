...
import { Monitor, Linkedin, Star, Presentation } from "lucide-react";
...
const categories = [
  {
    title: "Auditions & Casting",
    icon: <Star className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Casting Sites & Submissions",
        text: "Stand out on Backstage, Actors Access, Casting Networks, and other platforms with a sharp, dynamic image that gets you noticed first.",
      },
      {
        label: "Agency Portfolios & Comp Cards",
        text: "Impress agents and managers with polished headshots that show you're ready to book.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Online Profiles & Portfolios",
    icon: <Monitor className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Personal Dance Websites & Bio Pages",
        text: "Highlight your talent with a clean, modern photo on your website, bio page, and digital portfolio.",
      },
      {
        label: "LinkedIn & Social Media",
        text: "Build your professional brand on LinkedIn and Instagram with images that attract choreographers, directors, and collaborators.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Comp Cards & Agent Submissions",
        text: "Make a strong first impression with agents and managers using polished comp cards and submission packets that get you noticed.",
      },
      {
        label: "Competitions & Convention Profiles",
        text: "Stand out at dance competitions, conventions, and intensives with a sharp headshot on your registration and program profiles.",
      },
      {
        label: "Show Programs & Cast Bios",
        text: "Look professional in playbills, recital programs, and production cast pages with a headshot that matches the quality of the show.",
      },
      {
        label: "Dance Résumés & Audition Packets",
        text: "Attach a polished headshot to your dance résumé for company auditions, cruise lines, theme parks, and touring productions.",
      },
      {
        label: "Teaching Profiles & Studio Websites",
        text: "Build credibility as an instructor or choreographer with a professional photo on studio websites, class listings, and workshop promotions.",
      },
    ],
