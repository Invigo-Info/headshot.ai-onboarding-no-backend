...
import { Monitor, Linkedin, Users, Mail } from "lucide-react";
...
const categories = [
  {
    title: "Online Profiles & Listings",
    icon: <Monitor className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "MLS Listings & Property Pages",
        text: "Show up sharp on every listing with a clean, modern photo that builds instant trust with buyers and sellers.",
      },
      {
        label: "Zillow, Realtor.com & Real Estate Platforms",
        text: "Stand out on Zillow, Realtor.com, Redfin, and Trulia with a professional image that attracts more profile clicks and inquiries.",
      },
      {
        label: "Brokerage Websites & Team Pages",
        text: "Highlight your experience with a polished headshot on your brokerage site, team page, and agent bio.",
      },
      {
        label: "LinkedIn & Social Media Profiles",
        text: "Look credible on LinkedIn, Facebook, and Instagram with a sharp headshot that makes people want to work with you.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Marketing & Client Communications",
    icon: <Mail className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Client Updates",
        text: "Add your photo to emails, listing alerts, and market updates so clients recognize you instantly and feel more comfortable replying.",
      },
      {
        label: "Business Cards & Postcards",
        text: "Upgrade business cards, just-listed postcards, and neighborhood mailers with one polished photo that feels on-brand everywhere.",
      },
      {
        label: "Yard Signs & Billboard Ads",
        text: "Use your headshot on yard signs, billboards, and bus benches so neighbors remember your face and call you first.",
      },
      {
        label: "Listing Presentations & Seller Packets",
        text: "Put a face to your name on listing presentations, CMAs, and seller guides to build trust before you even meet.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Video Marketing & Social Media Ads",
        text: "Use your headshot on YouTube thumbnails, Instagram Reels, Facebook ads, and TikTok content so you look professional at a glance.",
      },
      {
        label: "Community Sponsorships & Local Events",
        text: "Look credible in charity events, youth sports programs, and community sponsorships with a headshot organizers actually want to use.",
      },
      {
        label: "Press Features & Market Reports",
        text: "Ideal for local news features, market update blogs, podcast appearances, and press releases so you look prepared when the media calls.",
      },
      {
        label: "Team Pages & Recruiting Materials",
        text: "Perfect for building your team, broker packets, and recruiting materials so you look like a leader worth joining.",
      },
    ],
