...
import { Monitor, Linkedin, Users, Award } from "lucide-react";
...
const categories = [
  {
    title: "Restaurant & Booking Platforms",
    icon: <Monitor className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: 'Restaurant Websites & "Meet the Chef" Pages',
        text: "Show guests who's behind the food with a polished photo on your bio page and kitchen team section.",
      },
      {
        label: "Yelp, OpenTable & Resy Profiles",
        text: "Make diners more likely to book when they see a sharp, credible chef photo on reservation platforms.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Private Dining & Catering Inquiry Pages",
        text: "Build trust before the first conversation — clients book chefs who look professional and approachable.",
      },
      {
        label: "Proposal Decks & Tasting Menu Cards",
        text: "Add your photo to catering proposals and menu cards so clients connect your face with your food.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Media, Publishing & Career",
    icon: <Award className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Cookbook Author Pages & Food Magazine Features",
        text: "Give editors a headshot they'll actually use — polished enough for Bon Appétit or your book jacket.",
      },
      {
        label: "Food Festival Demos & Guest Chef Appearances",
        text: "Look professional on event programs and speaker pages before you step behind the stove.",
      },
      {
        label: "James Beard, Competition Entries & Culinary Awards",
        text: "Present yourself at your best for nominations, competition applications, and industry recognition.",
      },
      {
        label: "Job Applications & Culinary School Portfolios",
        text: "Stand out in executive chef searches, stage requests, and culinary program applications.",
      },
    ],
