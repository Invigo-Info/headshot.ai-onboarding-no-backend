...
const categories = [
  {
    ...
    content: [
      {
        label: "Studio Websites & Bio Pages",
        text: "Highlight your teaching style with a calm, professional photo on your studio site, bio page, and team pages.",
      },
      {
        label: "Instagram, ClassPass & Mindbody",
        text: "Stand out on Instagram, ClassPass, Mindbody, and booking platforms with a serene, inviting image that attracts more clicks.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Student-Facing Touchpoints",
    icon: <Users className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Class Updates",
        text: "Add your photo to emails, newsletters, and class announcements so students recognize you instantly and feel connected.",
      },
      {
        label: "Workshop & Retreat Pages",
        text: "Put a face to your name on workshop registrations and retreat sign-ups to build trust and increase completed bookings.",
      },
      {
        label: "Yoga Alliance & Teacher Directories",
        text: "Use your headshot for Yoga Alliance profiles, teacher directories, and certification pages so you look polished in every official listing.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Upgrade business cards, flyers, and studio announcements with one beautiful photo that feels on-brand everywhere.",
      },
      {
        label: "Teacher Trainings & Yoga Festivals",
        text: "Use your headshot on training program websites, yoga festival lineups, and guest teacher profiles so you look professional before you step on stage.",
      },
      {
        label: "Online Class Platforms & Video Thumbnails",
        text: "Look polished on Zoom classes, YouTube thumbnails, and online course platforms so students feel confident clicking 'join.'",
      },
      {
        label: "Studio Applications & Teaching Auditions",
        text: "Ideal for applying to new studios, gyms, wellness centers, and teacher training programs so you make a strong first impression.",
      },
    ],
