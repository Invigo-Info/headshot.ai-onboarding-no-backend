...
export const categories = [
  {
    title: "Streaming & Music Platforms",
    icon: <Music className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Spotify, Apple Music & YouTube Music",
        text: "Make your artist profile stand out with sharp, professional images that match your music's quality.",
      },
      {
        label: "SoundCloud, Bandcamp & TuneCore",
        text: "Look credible and established on every platform where fans discover your music.",
      },
      {
        label: "Playlist Submissions & Curators",
        text: "Look like a serious artist when submitting to playlist curators and tastemakers who judge you by your image first.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Press, Social Media & Fan Engagement",
    icon: <Megaphone className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Electronic Press Kits & Music Blogs",
        text: "Include polished headshots in your EPK and give journalists and bloggers professional images they'll actually want to publish.",
      },
      {
        label: "Instagram, TikTok & Facebook",
        text: "Upgrade your profile photos and promotional posts with consistent, high-quality imagery that builds your visual brand.",
      },
      {
        label: "YouTube Channel Art & Thumbnails",
        text: "Use your headshots for channel branding and video thumbnails that get more clicks and subscribers.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Live Performance, Bookings & Networking",
    icon: <Mic className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Venue & Festival Submissions",
        text: "Look professional on booking platforms and event applications to land more gigs and festival spots.",
      },
      {
        label: "Concert Posters & Event Flyers",
        text: "Use your headshots for promotional materials that make you look stage-ready.",
      },
      {
        label: "Sonicbids, Bandsintown & Songkick",
        text: "Stand out on booking and touring platforms with polished artist imagery.",
      },
      {
        label: "LinkedIn, Business Cards & One-Sheets",
        text: "Present yourself professionally when connecting with industry contacts and leave behind materials that make a lasting impression.",
      },
    ],
