...
export const categories = [
  {
    title: "Casting & Agent Submissions",
    icon: <Clapperboard className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Backstage, Actors Access & Casting Networks",
        text: "Stand out on Backstage, Actors Access, Casting Networks, and other casting platforms with a sharp, professional headshot that gets you more clicks and callback requests.",
      },
      {
        label: "Agent & Manager Pitches",
        text: "Make a strong first impression when submitting to agents and managers with polished, industry-standard headshots that show you're serious and ready to work.",
      },
      {
        label: "Self-Tape Auditions & Video Submissions",
        text: "Use your headshot as your slate image for self-tape auditions so casting directors see a professional photo before you perform.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Profiles, Portfolios & Industry Directories",
    icon: <User className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "IMDb, LinkedIn & Social Media",
        text: "Build credibility on IMDb, LinkedIn, Instagram, and other platforms with a clean, professional image that helps industry pros remember you.",
      },
      {
        label: "Personal Website & Online Portfolio",
        text: "Showcase your look with high-quality headshots on your actor website and online portfolio so visitors see you at your best immediately.",
      },
      {
        label: "SAG-AFTRA, Actors Equity & Union Profiles",
        text: "Use your headshot for union profiles, membership cards, and official directories so you look polished in every professional context.",
      },
      {
        label: "Talent Databases & Industry Listings",
        text: "Stand out on Spotlight, Mandy, Stage 32, and other talent databases with a headshot that casting directors and producers want to click on.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Marketing, Press & Events",
    icon: <Megaphone className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Playbills, Programs & Production Materials",
        text: "Get your headshot in playbills, show programs, and production websites so audiences and industry pros know who you are.",
      },
      {
        label: "Press Kits, Media Features & Interviews",
        text: "Look credible in press releases, magazine features, podcasts, and media interviews with a headshot editors and journalists actually want to use.",
      },
      {
        label: "Headshot & Resume Packages",
        text: "Pair your new headshot with your resume for auditions, casting calls, and agent meetings so your materials look cohesive and professional.",
      },
      {
        label: "Workshops, Classes & Industry Events",
        text: "Use your headshot for workshop rosters, class directories, and industry event profiles so you're recognizable before you walk in the room.",
      },
    ],
...
export default ActorBenefitsSection;
