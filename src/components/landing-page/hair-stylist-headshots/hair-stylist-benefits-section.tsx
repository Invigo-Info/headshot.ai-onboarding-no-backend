...
import { Monitor, Linkedin, Award, Sparkles } from "lucide-react";
...
const categories = [
  {
    title: "Booking & Discovery Platforms",
    icon: <Monitor className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "StyleSeat, Vagaro, Booksy & Fresha Profiles",
        text: "Stand out on the apps where clients search for stylists. A polished headshot gets more clicks, more profile views, and more booking requests.",
      },
      {
        label: "Instagram & TikTok Bio",
        text: "Make your bio photo pop so new followers instantly see you as a pro worth following — and worth booking.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Salon & Personal Branding",
    icon: <Sparkles className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Salon Website & Team Pages",
        text: 'Look polished on your salon\'s site, staff directory, and "Meet the Team" page so clients request you by name.',
      },
      {
        label: "Chair Rental & Booth Renter Profiles",
        text: "Building your own clientele? A professional headshot helps you stand out from other stylists sharing the same space.",
      },
      {
        label: "Business Cards & Service Menus",
        text: "Put your best face on the cards you hand out and the menus clients browse while waiting in your chair.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Career Growth & Industry Presence",
    icon: <Award className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Brand Ambassador & Educator Applications",
        text: "Applying to represent a product line or teach for a brand? Your headshot is the first thing they see — make it count.",
      },
      {
        label: "Competition Entries & Hair Shows",
        text: "Submit a polished photo with your competition entries so judges see you as a serious, professional artist.",
      },
      {
        label: "Beauty Magazine & Blog Features",
        text: "When press opportunities come up, have a headshot ready that editors actually want to publish.",
      },
    ],
