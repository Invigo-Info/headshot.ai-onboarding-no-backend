...
import { Linkedin, Search, Briefcase, Megaphone } from "lucide-react";
...
export const categories = [
    ...
    content: [
      {
        ...
        text: "Stand out on LinkedIn, Indeed, Glassdoor, and professional networks with a sharp, credible image that attracts more views and connection requests.",
      },
      {
        label: "Company Websites & Team Pages",
        text: "Highlight your role with a clean, modern photo on your company site, team page, or department directory.",
      },
      {
        label: "Personal Website, Blog & Social Media",
        text: "Upgrade your personal brand across your website, Instagram, Twitter, and Facebook with a professional photo that signals credibility and expertise.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Resumes & CVs",
        text: "Make your resume stand out with a polished headshot that makes hiring managers remember you.",
      },
      {
        label: "Job Applications & Portfolios",
        text: "Put a face to your name on job applications and portfolio sites to build trust and increase callbacks.",
      },
      {
        label: "Interview Prep Materials",
        text: "Look polished before you even walk in — or log on. A great headshot sets the tone before you say a word.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Business, Networking & Media",
    icon: <Megaphone className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Email Signatures & Business Cards",
        text: "Add your photo to emails, business cards, and proposals so contacts recognize you instantly and feel more comfortable connecting.",
      },
      {
        label: "Conference Badges & Speaking Engagements",
      ...
      {
        label: "Publications, Press & Media Features",
        text: "Look credible in industry publications, blogs, podcasts, and press features with a headshot editors actually want to use.",
      },
    ],
