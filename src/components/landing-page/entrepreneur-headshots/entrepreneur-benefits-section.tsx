...
const categories = [
  {
    ...
    content: [
      {
        label: "Company Websites & Team Pages",
        text: "Showcase your leadership with a clean, modern photo on your company site, about page, and team bios.",
      },
      {
        label: "LinkedIn & Professional Networks",
        text: "Stand out on LinkedIn, AngelList, Crunchbase, and industry directories with a sharp, credible image that attracts more connection requests.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Investor & Partner Touchpoints",
    icon: <TrendingUp className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Pitch Decks & Investor Updates",
        text: "Add your photo to pitch decks, investor memos, and quarterly updates so VCs and angels recognize you instantly and feel more connected.",
      },
      {
        label: "Conference Badges & Event Credentials",
        text: "Use your headshot for speaker badges, event IDs, and networking apps so you look polished at every event.",
      },
      {
        label: "Partnership Proposals & Outreach",
        text: "Put a face to your name on proposals and cold emails to build trust and increase response rates.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Marketing, Media & Personal Brand",
    icon: <Presentation className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Business Cards & Printed Materials",
        text: "Upgrade business cards, brochures, and company announcements with one polished photo that feels on-brand everywhere.",
      },
      {
        label: "Conferences, Podcasts & Speaking Engagements",
        text: "Use your headshot on event websites, podcast pages, speaker profiles, and slide decks so you look professional before you're on stage.",
      },
      {
        label: "Publications, Press & Media Kits",
        text: "Look credible in Forbes, Inc., TechCrunch, and press releases with a headshot journalists actually want to use.",
      },
      {
        label: "Personal Websites & Thought Leadership",
        text: "Ideal for personal blogs, newsletter author photos, and Medium profiles so you look established at a glance.",
      },
    ],
