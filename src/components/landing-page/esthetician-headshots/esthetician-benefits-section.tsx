...
export const categories = [
  {
    title: "Booking Platforms & Online Profiles",
    icon: <CalendarCheck className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Vagaro, Booksy, StyleSeat & GlossGenius",
        text: "Stand out in search results with a polished headshot that makes clients choose you over other estheticians in your area.",
      },
      {
        label: "Instagram & Social Media",
        text: "Build a cohesive, professional feed with headshots that match your brand aesthetic and attract your ideal skincare clients.",
      },
      {
        label: "Yelp & Google Business",
        text: "Look trustworthy and credible when potential clients search for facials, waxing, or skincare services near them.",
      },
      {
        label: "Spa & Skincare Website Bio Pages",
        text: "Highlight your expertise with a clean, modern photo on your spa site, about page, and team directory.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Client Trust & Brand Building",
    icon: <BadgeCheck className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Consultation & Booking Pages",
        text: "Put a face to your name on intake forms and booking pages so clients feel comfortable before their first appointment.",
      },
      {
        label: "Confirmations & Follow-Ups",
        text: "Add your photo to confirmation emails and aftercare instructions so clients recognize you and feel a personal connection.",
      },
      {
        label: "Client Welcome Materials",
        text: "Include your headshot in new client packets, treatment menus, and skincare recommendation sheets to build rapport.",
      },
      {
        label: "Business Cards, Brochures & Gift Cards",
        text: "Upgrade your business cards, service menus, gift cards, and loyalty program materials with one polished photo that feels on-brand.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Esthetician License & Certifications",
        text: "Use your headshot for license renewals, certification profiles, and continuing education platforms.",
      },
      {
        label: "Job Applications & Spa Interviews",
        text: "Look polished on resumes, portfolios, and applications when applying to top spas and medical aesthetics clinics.",
      },
      {
        label: "Beauty Industry Events & Education",
        text: "Use your headshot on speaker profiles, training certificates, and beauty expo badges to look professional at industry events.",
      },
    ],
