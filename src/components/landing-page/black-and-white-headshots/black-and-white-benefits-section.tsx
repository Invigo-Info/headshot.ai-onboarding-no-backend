...
import { Monitor, Linkedin, Briefcase, Sparkles } from "lucide-react";
...
export const categories = [
  {
    title: "Online Profiles & Personal Branding",
    icon: <Monitor className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "LinkedIn & Professional Networks",
        text: "Stop the scroll with a striking black & white headshot. Stand out in a sea of color photos and look instantly more distinguished and memorable.",
      },
      {
        label: "Portfolio Websites, Bio Pages & Directories",
        text: "Create a cohesive, artistic look across your online presence — from Behance and Dribbble to personal sites. Black & white adds elegance and makes your brand feel timeless.",
      },
      {
        label: "Social Media Profiles",
        text: "Create consistency across Instagram, X, and other platforms with a signature black & white look that's instantly recognizable.",
      },
      {
        label: "Email Signatures & Career Materials",
        text: "Add a touch of class to every email and stand out in resumes and applications with a distinguished headshot that signals confidence.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Creative & Artistic Uses",
    icon: <Sparkles className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Acting & Modeling Portfolios",
        text: "Black & white headshots are a casting essential. Show range and professionalism with classic shots that never go out of style.",
      },
      {
        label: "Author Photos & Book Jackets",
        text: "Give your author bio the timeless feel publishers love. Black & white photos work across genres and look great in print.",
      },
      {
        label: "Music & Artist Profiles",
        text: "Whether you're a solo artist or in a band, black & white headshots add artistic credibility to your press kit and streaming profiles.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "A black & white headshot elevates printed materials with sophisticated simplicity. Perfect for cards, brochures, and firm announcements.",
      },
      {
        label: "Speaking Engagements & Events",
        text: "Look polished on event websites, conference programs, and speaker slides. Black & white photos reproduce beautifully in any format.",
      },
      {
        label: "Press & Media Features",
        text: "Give journalists and editors a professional, high-contrast image they'll actually want to use in print or digital publications.",
      },
    ],
