...
import { Linkedin, GraduationCap, Clapperboard, Theater } from "lucide-react";
...
export const categories = [
  {
    title: "Audition & Casting Submissions",
    icon: <Clapperboard className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Actors Access & Casting Networks",
        text: "Stand out on major casting platforms with sharp, professional headshots that make casting directors want to see more.",
      },
      {
        label: "Backstage & Self-Submissions",
        text: "Increase your chances of getting called in with headshots that show your range and type at a glance.",
      },
      {
        label: "Agent & Manager Submissions",
        text: 'Make a strong first impression when seeking representation with photos that say "ready to book."',
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Profiles, Portfolios & Theatre Programs",
    icon: <Theater className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "IMDb, Spotlight & StageAgent",
        text: "Look polished and professional on industry databases where casting teams search for talent.",
      },
      {
        label: "Personal Website & EPK",
        text: "Build a professional portfolio with consistent, high-quality headshots across your electronic press kit and website.",
      },
      {
        label: "LinkedIn & Social Profiles",
        text: "Present yourself professionally on networking platforms where industry connections happen.",
      },
      {
        label: "Playbills & Theatre Programs",
        text: "Look your best in printed programs alongside your bio and credits.",
      },
      {
        label: "Promotional Materials & Press Coverage",
        text: "Provide production teams with high-resolution headshots for posters and marketing, and give publications professional photos they'll actually want to use.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Conservatory & BFA Applications",
        text: "Submit polished headshots with grad school and training program applications.",
      },
      {
        label: "Showcase & Industry Presentations",
        text: "Look professional at showcases where agents and casting directors discover new talent.",
      },
      {
        label: "Actors' Equity & Union Materials",
        text: "Use professional headshots for union profiles and official industry documentation.",
      },
    ],
