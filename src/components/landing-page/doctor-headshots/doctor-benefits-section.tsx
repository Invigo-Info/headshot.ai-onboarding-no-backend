...
export const categories = [
  {
    title: "Patient-Facing Profiles",
    icon: <Stethoscope className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Medical Directory Listings",
        text: "Stand out on Healthgrades, Vitals, ZocDoc, WebMD, Doximity, and RateMDs where people search for doctors. A professional photo builds instant trust and increases clicks.",
      },
      {
        label: "Practice Website & Provider Bio",
        text: 'Show patients who you are before they book. Use your headshot on your homepage, "Meet the Doctor" page, and provider directory so patients feel comfortable choosing you.',
      },
      {
        label: "Telehealth & Patient Portals",
        text: "Look professional on telemedicine platforms and patient portals so patients recognize you before their video visit or when logging in.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Credentials, Systems & Career Development",
    icon: <BadgeCheck className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Hospital Badges, Licenses & Board Profiles",
        text: "Use your headshot for employee IDs, hospital directories, state medical board profiles, ABMS certifications, and specialty board listings.",
      },
      {
        label: "Insurance Provider Directories & Credentialing",
        text: "Stand out in Aetna, UnitedHealthcare, Blue Cross, Cigna, and other insurance networks, and include your headshot on credentialing packets and privileging renewals.",
      },
      {
        label: "Applications & Professional Profiles",
        text: "Stand out in ERAS applications, fellowship materials, academic CVs, promotion packets, job applications, and medical society profiles (AMA, specialty societies, state associations).",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Communication, Marketing & Academic",
    icon: <Megaphone className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Email Signatures & Patient Communications",
        text: "Add your photo to appointment confirmations, follow-up emails, and newsletters so patients recognize and trust you.",
      },
      {
        label: "Business Cards & Marketing Materials",
        text: "Upgrade your business cards, brochures, appointment cards, local ads, and community outreach materials with one consistent photo.",
      },
      {
        label: "Social Media & LinkedIn",
        text: "Build your professional brand on LinkedIn and practice social accounts with a credible headshot that attracts patients.",
      },
      {
        label: "Conferences, Publications & Teaching",
        text: "Use your headshot on conference websites, CME programs, speaker bios, journal articles, teaching materials, and medical school directories.",
      },
    ],
