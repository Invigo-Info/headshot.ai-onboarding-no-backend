...
import { Monitor, Linkedin, Briefcase, Users } from "lucide-react";
...
const categories = [
  {
    ...
    content: [
      {
        label: "Practice Websites & Bio Pages",
        text: "Show your warmth with a clean, inviting photo on your practice site, about page, and team pages.",
      },
      {
        label: "Psychology Today & Therapy Directories",
        text: "Stand out on Psychology Today, TherapyDen, GoodTherapy, and other directories with a warm, credible image that attracts more clicks.",
      },
      {
        label: "LinkedIn & Professional Networks",
        text: "Look polished and approachable on LinkedIn so referral sources, colleagues, and potential clients see you as established and trustworthy.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Client-Facing Touchpoints",
    icon: <Users className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Client Communications",
        text: "Add your photo to emails, intake forms, and appointment reminders so clients recognize you instantly and feel more comfortable reaching out.",
      },
      {
        label: "Insurance Panels & Credentialing",
        text: "Use your headshot for insurance directories, panel applications, and credentialing documents so you look polished in every official context.",
      },
      {
        label: "Client Intake & Booking Pages",
        text: "Put a face to your name on SimplePractice, TherapyNotes, or your booking page to build trust and increase completed consultations.",
      },
      {
        label: "Telehealth Profiles",
        text: "Look professional on video platforms like Doxy.me, Zoom, or your EHR's client portal so clients feel at ease before sessions even begin.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Professional Growth & Outreach",
    icon: <Briefcase className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Workshops, CEUs & Group Programs",
        text: "Use your headshot on flyers, registration pages, and promotional materials for any workshops, groups, or trainings you offer.",
      },
      {
        label: "Referral Materials & Networking",
        text: "Share a polished photo with physicians, psychiatrists, and other referral sources so they remember you and feel confident sending clients your way.",
      },
      {
        label: "Supervision & Training Profiles",
        text: "If you supervise interns or offer consultation, a professional headshot builds credibility with supervisees and training programs.",
      },
      {
        label: "Job Applications & Hospital Positions",
        text: "Ideal for community mental health roles, hospital positions, or group practice applications where a professional image sets you apart.",
      },
    ],
