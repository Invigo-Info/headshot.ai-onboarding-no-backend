...
import { Monitor, Linkedin, TrendingUp, Users } from "lucide-react";
...
const categories = [
    ...
    content: [
      {
        ...
        text: "Highlight your expertise with a warm, professional photo on your practice site, bio page, and team pages.",
      },
      {
        label: "Psychology Today, GoodTherapy & Directories",
        text: "Stand out on Psychology Today, GoodTherapy, TherapyDen, Zencare, and other directories with a warm, credible image that attracts more clicks.",
      },
      {
        label: "LinkedIn & Professional Networks",
        text: "Make a strong first impression on LinkedIn and professional networks with a polished, approachable headshot.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Add your photo to emails, intake paperwork, and updates so clients recognize you instantly and feel more comfortable reaching out.",
      },
      {
        label: "Telehealth Profiles & Booking Pages",
        text: "Put a face to your name on telehealth platforms and booking pages to build trust and increase completed consultations.",
      },
      {
        label: "Insurance Panels & Provider Directories",
        text: "Use your headshot for insurance panels and provider directories so you look polished in every professional listing.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Business Cards & Referral Materials",
        text: "Upgrade business cards and referral sheets with a warm, professional photo that helps other providers remember you.",
      },
      {
        label: "APA Conferences, CE Workshops & Speaking Events",
        text: "Use your headshot on conference programs, CE workshop listings, and speaker bios so you look credible before you present.",
      },
      {
        label: "Publications, Podcasts & Expert Features",
        text: "Look polished in psychology journals, mental health podcasts, news interviews, and expert commentary with a headshot media outlets want to use.",
      },
      {
        label: "Academic & Career Applications",
        text: "Ideal for postdoc applications, faculty positions, hospital credentialing, and promotion packets so you make a strong impression at a glance.",
      },
    ],
