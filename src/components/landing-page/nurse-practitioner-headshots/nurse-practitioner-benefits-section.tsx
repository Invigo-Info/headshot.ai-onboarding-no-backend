...
const categories = [
  {
    ...
    content: [
      {
        label: "Practice & Clinic Websites",
        text: "Give patients confidence before they book. A polished headshot on your provider page makes you look experienced, trustworthy, and ready to care for them.",
      },
      {
        label: "LinkedIn & Doximity",
        text: "Make a strong first impression on colleagues, recruiters, and referring providers with a headshot that shows you're serious about your career.",
      },
      {
        label: "Healthcare Directories (Healthgrades, Zocdoc, WebMD, etc.)",
        text: "Stand out in search results with a professional photo that builds trust and drives more appointment bookings.",
      },
      {
        label: "Hospital & Health System Staff Pages",
        text: "Look consistent with other providers on your organization's website with a high-quality headshot that meets their standards.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Patient Portals & MyChart Profiles",
        text: "Give patients a face to connect with before their first visit — build rapport before you even meet.",
      },
      {
        label: "Telehealth Platforms",
        text: "Make virtual visits feel more personal with a warm, professional headshot patients see before they connect.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Stand out in a competitive job market with a polished headshot that shows you're prepared and professional at first glance.",
      },
      {
        label: "Email Signatures",
        text: "Add a professional touch to every email and make your communications feel more personal and trustworthy.",
      },
    ],
