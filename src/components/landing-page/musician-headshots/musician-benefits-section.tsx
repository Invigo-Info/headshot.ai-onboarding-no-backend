...
import { Linkedin, ShoppingBag, FileText, Music } from "lucide-react";
...
const categories = [
  {
    title: "Streaming & Online Profiles",
    icon: <Music className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "Spotify, Apple Music & Streaming Platforms",
        text: "Make your artist profile pop with sharp, professional photos that catch listeners scrolling through playlists.",
      },
      {
        label: "YouTube, SoundCloud & Bandcamp",
        text: "Stand out on video platforms and indie music sites with headshots that match your sound's quality.",
      },
      {
        label: "Social Media (Instagram, TikTok, Facebook)",
        text: "Upgrade your profile pics and posts with consistent, eye-catching photos that grow your following.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Press & Booking Materials",
    icon: <FileText className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Electronic Press Kits (EPKs)",
        text: "Give journalists, bloggers, and playlist curators professional photos they'll actually want to use in features.",
      },
      {
        label: "Booking Submissions & Festival Applications",
        text: "Look like a headliner on venue inquiries, festival submissions, and booking agent portfolios.",
      },
      {
        label: "Music Industry Profiles & Directories",
        text: "Shine on AllMusic, Bandsintown, Songkick, and industry databases where bookers discover new talent.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Marketing, Merch & Career",
    icon: <ShoppingBag className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "Album Art & Single Covers",
        text: "Use your headshots as cover art elements or promotional visuals for releases.",
      },
      {
        label: "Merchandise & Posters",
        text: "Put your best face on t-shirts, posters, and merch without paying for a separate product shoot.",
      },
      {
        label: "Business Cards & One-Sheets",
        text: "Upgrade your physical promo materials with one polished photo that feels on-brand everywhere.",
      },
      {
        label: "LinkedIn & Professional Profiles",
        text: "Look credible for sync licensing meetings, label pitches, and music business networking.",
      },
    ],
