...
const categories = [
  {
    ...
    content: [
      {
        label: "Hospital Websites & Bio Pages",
        text: "Highlight your expertise with a clean, modern photo on your hospital site, bio page, and department pages.",
      },
      {
        label: "LinkedIn & Medical Directories",
        text: "Stand out on LinkedIn, Doximity, Healthgrades, Zocdoc, and other directories with a sharp, credible image that attracts more clicks.",
      },
    ],
    Visual: OnlineProfilesVisual,
  },
  {
    title: "Patient & Colleague-Facing Touchpoints",
    icon: <Users className="w-6 h-6 text-purple-600" />,
    headerIconBg: "bg-purple-100",
    content: [
      {
        label: "Email Signatures & Patient Communications",
        text: "Add your photo to emails, consultation letters, and updates so patients recognize you instantly and feel more comfortable.",
      },
      {
        label: "Hospital Badges & ID Cards",
        text: "Use your headshot for hospital credentials, staff IDs, and internal systems so you look polished in every official context.",
      },
      {
        label: "Patient Intake & Consultation Pages",
        text: "Put a face to your name on intake forms and booking pages to build trust and increase booked consultations.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Medical Conferences & CME Events",
        text: "Use your headshot on conference websites, programs, speaker profiles, and presentation slides so you look professional before you step on stage.",
      },
      {
        label: "Journal Publications & Research Profiles",
        text: "Look credible in medical journals, research papers, and academic profiles with a headshot that reflects your expertise.",
      },
      {
        label: "CV, Fellowship & Faculty Applications",
        text: "Ideal for CV updates, fellowship applications, residency program profiles, faculty appointments, and promotion packets.",
      },
      {
        label: "Grand Rounds & Department Announcements",
        text: "Present yourself professionally in internal hospital communications, grand rounds announcements, and department introductions.",
      },
    ],
