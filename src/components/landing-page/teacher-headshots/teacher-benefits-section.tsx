...
import { Monitor, Linkedin, Users, Briefcase } from "lucide-react";
...
const categories = [
  {
    title: "School & Classroom Presence",
    icon: <Monitor className="w-6 h-6 text-blue-600" />,
    headerIconBg: "bg-blue-100",
    content: [
      {
        label: "School Websites & Staff Directories",
        text: "Show parents and students who you are with a clean, modern photo on your school site and staff directory.",
      },
      {
        label: "Google Classroom, Canvas & LMS Profiles",
        text: "Use your headshot on learning management systems so students see a friendly face when they log in.",
      },
      {
        label: "Email Signatures & Parent Communications",
        text: "Add your photo to emails and newsletters so families recognize you instantly and feel more comfortable replying.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Parent-Teacher Conference Materials",
        text: "Put a face to your name on conference schedules and booking pages to build trust before families walk in the door.",
      },
      {
        label: "School Apps & Communication Platforms",
        text: "Look professional on Remind, ClassDojo, and Seesaw so your messages feel more personal and trustworthy.",
      },
    ],
    Visual: ClientTouchpointsVisual,
  },
  {
    title: "Professional Growth & Career",
    icon: <Briefcase className="w-6 h-6 text-green-600" />,
    headerIconBg: "bg-green-100",
    content: [
      {
        label: "LinkedIn & Educator Job Boards",
        text: "Stand out on LinkedIn, Indeed, and SchoolSpring with a sharp, welcoming image that attracts recruiters.",
      },
      {
        label: "Teaching Résumés & Professional Applications",
        text: "Look prepared on résumés, National Board Certification, and Teacher of the Year nominations.",
      },
      {
        label: "Conferences & Speaking Engagements",
        text: "Add your photo to presenter bios and conference programs when sharing your expertise at workshops and PD events.",
      },
      {
        label: "Teacher Blogs, Publications & Media",
        text: "Look credible in education journals, teacher blogs, and local news features with a headshot editors want to publish.",
      },
      {
        label: "Teachers Pay Teachers & Educator Marketplaces",
        text: "Build trust with fellow teachers by adding a professional headshot to your TPT or Boom Learning profile.",
      },
    ],
