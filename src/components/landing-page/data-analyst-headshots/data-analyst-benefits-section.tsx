...
const categories = [
    ...
    content: [
      {
        ...
        text: "Stand out on LinkedIn, Indeed, Glassdoor, and data science communities with a sharp, credible image that attracts more profile views and recruiter messages.",
      },
      {
        label: "Company Websites & Team Pages",
        text: "Look polished on your company's about page, team directory, and internal profiles so you make a great impression on colleagues and clients.",
      },
    ],
    ...
    content: [
      {
        ...
        text: "Add a professional photo to your resume, CV, and application materials so you look prepared and polished at first glance.",
      },
      {
        label: "Portfolio Sites & GitHub",
        text: "Upgrade your personal portfolio, GitHub profile, and data science blogs with a headshot that shows you're serious about your craft.",
      },
      {
        label: "Interview Prep & Virtual Meetings",
        text: "Use your headshot as a Zoom background placeholder or add it to pre-interview materials so hiring managers see your professional side.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        label: "Email Signatures & Slack",
        text: "Add your photo to emails, Slack, Teams, and internal tools so colleagues recognize you instantly — especially on remote teams.",
      },
      {
        label: "Conference Badges & Speaker Profiles",
        text: "Use your headshot for data conferences, meetup profiles, webinar bios, and speaking engagements so you look professional before you present.",
      },
      {
        label: "Business Cards & Networking Materials",
        text: "Upgrade business cards and networking materials with one consistent, polished photo that feels on-brand everywhere you connect.",
      },
    ],
